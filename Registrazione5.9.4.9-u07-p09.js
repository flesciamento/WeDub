...
function CaricaColonnaInternazionale(Dati) {
    ...
    function CaricaSpezzoneSuccessivo() {
        CreaNuovaClipAudio({Registrazione: SpezzoniAudioCI[NumSpezzone], N: (NumSpezzone + 1) * -1, ID_Utente: 'CI', MinutaggioRegistrazione: 75 * NumSpezzone, TaglioIniziale: 0, TaglioFinale: 75, Guadagno: Dati.volume},
            (datiAudio) => {
