                    ...
                    const divTrattamentoAudio = CreaElemento('div', ID_Opzioni + 'divTrattamentoAudio', divOpzioniVarie.id); divTrattamentoAudio.className = "btn"; divTrattamentoAudio.iStyle({cursor: "auto", width: "fit-content"});
                        const fieldsetTrattamentoAudio = CreaElemento('fieldset', divTrattamentoAudio.id + "fieldset", divTrattamentoAudio.id);
                            ...
                            pulSpezzaBattute.onclick = async (e) => {
                                ...
                                if (NumeroAttacchi > 1) {
                                    const slideTaglioIniziale = document.getElementById(ID_Opzioni + 'TabellaOpzioniRigaTaglioInizialeSlide'); slideTaglioIniziale.value = attacchi[0]; slideTaglioIniziale.dispatchEvent(ev_cambiamento);
                                    const slideTaglioFinale = document.getElementById(ID_Opzioni + 'TabellaOpzioniRigaTaglioFinaleSlide'); slideTaglioFinale.value = attacchi[1]; slideTaglioFinale.dispatchEvent(ev_cambiamento);
