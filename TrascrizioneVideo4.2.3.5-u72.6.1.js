...
function GestisciImmissioneTesto(e) {
    ...
    if (Object.keys(TastiIndicazioni).includes(e.key)) {
        ...
        if (e.key == "F1") {
            ...
            PosizionaCursore(ElementoAttuale.childNodes[0], 0);
            nuovatextarea = T;
...
FunzioniCopione.FunzioneModificaPersonaggio = (e) => {SospendiRipresaVideo(e.currentTarget); AttivaSceltaPersonaggio(e.currentTarget, ModificaPersonaggio)};
FunzioniCopione.FunzioneModificaBattuta = GestisciImmissioneTesto;
FunzioniCopione.FunzioneAlBlurBattuta = GestisciBlur;
