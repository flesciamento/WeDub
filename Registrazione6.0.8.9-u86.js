...
function RiposizionamentoAutomaticoClipSovrapposte(ELTAttuale) {
    if (ELTDaSpostare == false) {
        const IDTraccia = ELTAttuale.parentNode.id, ELTStratoColore = document.getElementById(ELTAttuale.id + 'StratoColore'), leftColoreELTAttuale = (+ELTAttuale.offsetLeft) + (+ELTStratoColore.offsetLeft), widthColoreELTAttuale = ELTStratoColore.offsetWidth, TermineELTAttuale = (+leftColoreELTAttuale) + (+widthColoreELTAttuale);
