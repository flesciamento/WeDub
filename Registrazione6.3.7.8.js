...
function PosizionaElementiScroll() {
    ...
    WindowScrollY = window.scrollY.arrotonda(3);
}
/**********************************************/
...
function SeguiCursore() {
    const percZoom = (DimensioneRighello / slideZoom.max), percMinima = 0.2, CondizioneMinima = (percZoom > percMinima);
    window.scrollTo(Cursore.offsetLeft - (ScorrimentoCursore_DistanzaMinimaDalBordo / ((percZoom * CondizioneMinima) + (percMinima * !CondizioneMinima))), WindowScrollY);
}
