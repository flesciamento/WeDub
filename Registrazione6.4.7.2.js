...
function ScorciatoieTastiera(Tasto) {
    ...
    switch(Tasto.code) {
        ...
        case "ArrowLeft":
        case "ArrowRight": Tasto.preventDefault(); const NuovoMinutaggio = +VideoGuidaMinutaggioCorrente() + (0.1 * (1 - (2 * (Tasto.code == "ArrowLeft")))); Posizionati(NuovoMinutaggio * (NuovoMinutaggio > 0)); return;
