...
function DisabilitaElementiGenerali(Disabilita) {
    ...
    SelezioneMicrofono.abilita(!Disabilita); pulMonitorMic.abilita(!Disabilita); opzCanaleRegistrazione.disabled = Disabilita; selectQualitaRegistrazione.disabled = Disabilita;
