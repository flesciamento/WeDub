...
function CambiaTool(Tool) {
    ...
    const ELT_EventoTouchStart = ((Tool == toolDividiClip) ? GestioneEventoELTCliccato : "");
    ...
    for (let I = 0; (I < totELT); I++) {
        if (ELT[I].dataset.modificabile) {ELT[I].style.cursor = puntatore; ELT[I].ontouchstart = ELT_EventoTouchStart;}
    }
...
function CreaElementoLineaTemporale(ID, DoveInserirlo, PartenzaRegistrazione, LunghezzaRegistrazione, Stringa, RiferimentoRegistrazione, Posizione, Altezza, imgOndaSonora, DaVisualizzare) {
    ...
    ELT.title = Stringa; ELT.className = "ELT transizione-morbida-si"; ELT.setAttribute("name", "ELT"); ELT.iStyle({display: "none", opacity: 0.8, transform: "scaleY(0.9)", position: 'absolute', top: Posizione, height: Altezza, pointerEvents: "none"});
    ...
    InserimentoInProporzioneNellaLineaTemporale(ELT, PartenzaRegistrazione, LunghezzaRegistrazione);
        ...
        const ContenutoELT = CreaElemento('div', ID + "Contenuto", ID); ContenutoELT.className = "ContenutoELT";
            ...
            const StratoColoreELT   = CreaElemento('div', ID + 'StratoColore', ContenutoELT.id); StratoColoreELT.className = "StratoColoreELT"; StratoColoreELT.style.transition = "all 2s"; StratoColoreELT.style.pointerEvents = "all";
...
function AnteprimaSelezioneClip(ELTConsiderato, ClientX) {
    ...
    AnteprimaSelezioneClip.Visualizza = (e) => {
        ...
        if (SistemaAttualeAndroid) {
            ...
            AnteprimaSelezioneClip.tmr = setTimeout(() => {DividiClip_puntatorerilasciato(e);}, 1000);
        }
    };
...
function OpzioniClip(Numero, Apri, SalvaAllaChiusura) {
    ...
    if (Apri) {
        ...
        ELT.ontouchstart = GestioneEventoELTCliccato;
        ...
        ELTDaSpostare = false;
        ELT.className = "ELT transizione-morbida-si"; ELT.ontouchstart = "";
