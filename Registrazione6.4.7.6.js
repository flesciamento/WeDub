...
function PlayVideoGuida() {
    if (Math.round(VideoGuidaMinutaggioCorrente()) >= Math.round(totDurataVideoGuida)) {VideoGuidaPause(); RiproduzioneInCorso = true; Posizionati(InizioVideoGuida); return;}
