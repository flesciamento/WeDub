        ...
        if (RiproduzioneInCorso == false) {
            ...
            if (StoRegistrando == false) {
                ...
                if ((checkAscoltaClipDuranteRegistrazione.checked) || (opzFunzionalitaPreRegistrazione.value == "preroll")) {
                    if ((!checkAscoltaClipDuranteRegistrazione.checked) && (opzFunzionalitaPreRegistrazione.value != "preroll")) {DisattivaClipNonCI(true);} // Se non è stato selezionato: "riproduci clip mentre registri", vengono temporaneamente disattivate tutte le clip diverse dalla colonna internazionale.
