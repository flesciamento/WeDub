...
function AvviaContoAllaRovesciaRegistrazione() {
    ...
    const MinutaggioVideo = VideoGuidaMinutaggioCorrente();
    DisabilitaSchermata(true); PrecaricaClip(MinutaggioVideo, MinutaggioVideo + SecondiPrecaricamentoAlPlayPrimaDiRegistrare, DisabilitaSchermata); // Precarica le eventuali clip da riprodurre nell'attesa del conto alla rovescia
