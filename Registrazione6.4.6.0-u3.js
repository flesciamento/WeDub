...
function AggiornaRappresentazioneColonnaInternazionale() {
    ...
    divCIStato.style.backgroundImage = `linear-gradient(90deg, ${colorePorzioneTagliata} 0%, ${colorePorzioneTagliata} ${PercentualeMinutaggio(InizioVideoGuida)} ${strSfondo} ${colorePorzioneTagliata} ${PercentualeMinutaggio(totDurataVideoGuida)} ${colorePorzioneTagliata} 100%)`;
