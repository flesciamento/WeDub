...
function RiposizionamentoAutomaticoClipSovrapposte(ELTConsiderato) {
    if (ELTDaSpostare == false) {
        ...
        NuoviELTDaRiordinare.sort((a, b) => {return DatiAudioRegistrato[a.dataset.RiferimentoRegistrazione].Durata - DatiAudioRegistrato[b.dataset.RiferimentoRegistrazione].Durata;});
