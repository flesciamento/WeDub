                            ...
                            pulSpezzaBattute.onclick = async (e) => {
                                ...
                                if (NumeroAttacchi > 1) {
                                    ...
                                    for(A = 2; A < NumeroAttacchi; A += 2) {
                                        ...
                                        DuplicaClip(Numero, (ClipNuova) => {ClipNuova.taglioIniziale = SecondiAttacco; ClipNuova.taglioFinale = SecondiStacco; SelezionaESpostaELT(ClipNuova.numero); VisualizzazioneGraficaTaglioClip(ClipNuova.numero); NuoveClipCreate.push(ClipNuova); if (NuoveClipCreate.length >= (NumeroAttacchi / 2) - 1) {Riattiva();}});
                                    }
                                } else {
                                    Riattiva();
                                }
