...
function AvviaContoAllaRovesciaRegistrazione() {
    ...
    DisabilitaSchermata(true); PrecaricaClip(MinutaggioVideo, VideoGuidaMinutaggioCorrente() + SecondiPrecaricamentoAlPlayPrimaDiRegistrare, DisabilitaSchermata); // Precarica le eventuali clip da riprodurre nell'attesa del conto alla rovescia
