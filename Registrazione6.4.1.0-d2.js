...
function AdattaDimensionePulsanti() {
    ...
    if (OrientamentoSchermoOrizzontale()) {
        const d = CreaElemento('div', 'debugdiv', 'bodyPagina', "Orientamento schermo: " + screen.orientation.type); d.className = "alert alert-warning"; d.iStyle({position: "fixed", top: "1%", left: "1%", zIndex: 10000000000000});
