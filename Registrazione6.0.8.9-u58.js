...
function EliminaEventiPuntatoreDividiClip(ELT) {
    ...
    document.body.removeEventListener('mouseup', DividiClip_puntatorerilasciato);   document.body.removeEventListener('touchcancel', DividiClip_puntatorerilasciato);
}
                ...
                switch(StrumentoMouse) {
                    ...
                    case toolDividiClip:
                        ...
                        if ((datiAudio.taglioIniziale < MinutaggioSelezionatoClip) && (MinutaggioSelezionatoClip < datiAudio.taglioFinale)) {
                            ...
                            document.body.addEventListener('mouseup', DividiClip_puntatorerilasciato);  document.body.addEventListener('touchcancel', DividiClip_puntatorerilasciato);
                        }
                    break;
