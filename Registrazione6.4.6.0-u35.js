...
function AggiornaRappresentazioneColonnaInternazionale(AggiornaSeModificato = false) {
    ...
    TracciaCI.iStyle({backgroundImage: `linear-gradient(90deg, ${colorePorzioneTagliata} 0%, ${colorePorzioneTagliata} ${PercentualeMinutaggio(InizioVideoGuida)} ${strSfondo})`, backgroundSize: "100% 100%"});
