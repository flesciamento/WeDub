...
function OperazioniAlBufferCaricato(Numero, FunzioneAlTermine = () => {}) {
    ...
    if (DatiAudioRegistrato[Numero].daAscoltare) {VisualizzaModificaAudioAscoltato();}
...
function CreaFinestraOpzioniClip(RiferimentoRegistrazione) {
    ...
    function AggiornaModificheClip() {
         ...
         const AutoreCommenti = (SonoCreatoreProgetto? "CreatoreProgetto" : "Doppiatore"), DestinatarioCommenti = (SonoCreatoreProgetto? "Doppiatore" : "CreatoreProgetto");
