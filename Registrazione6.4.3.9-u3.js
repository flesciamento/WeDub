...
function DeterminaVolumeVideoGuidaPerCI() {
    if (ColonnaInternazionaleAttivata) {
        ...
        if (PosizioneConAudioOriginale) {
            ...
            if (PosizioneSuccessiva = DatiCI[+DatiCI.indexOf(PosizioneConAudioOriginale) + 1]) {CI_DisattivaAudioOriginaleAlPlay(DatiAudioRegistrato_Registrazione[PosizioneSuccessiva.CI[0]]);}
        } else {
