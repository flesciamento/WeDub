    ...
    if (!ModalitaStreaming) {
        ...
        setTimeout(() => {
            ...
            if (RuoliDaAssegnare_NumeroTraccia !== false) {
                ...
                if (!SonoCreatoreProgetto && !SessioneOspite) {AltezzaTracce = window.innerHeight - ((UnitaDiMisura == "%") ? (window.innerHeight * 0.3) : NomiTracce.children[0].offsetHeight) - 200; VariaAltezzaTracce();} // Ingrandisce lo spazio dedicato al video per i doppiatori
            }
