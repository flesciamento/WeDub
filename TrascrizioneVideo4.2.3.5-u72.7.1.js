...
function AggiornaTestoGuida_slow() {
    ...
    AggiornaTestoGuida_slow.tmr = setTimeout(() => {FunzioniCopione.Visualizza(); FunzioniCopione.AggiornaTestoGuida(); if (RiproduzioneInCorso) {FunzioniCopione.AttivaTestoGuida();}}, 500);
}
