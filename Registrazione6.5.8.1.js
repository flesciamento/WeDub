...
function ScorciatoieTastiera(e) {
    var Tasto = e.code, TastoPremuto = "", SpiegazioneTasto = "";
    ...
    switch(Tasto) {
        ...
        case "KeyS": Tasto = scorciatoieTool[toolStandard]; TastoPremuto = "S"; break;
    }

    if (!e.ctrlKey && scorciatoieTool.includes(Tasto)) {
