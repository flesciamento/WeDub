...
var FunzioniCopione = {
    ...
    Visualizza: function () {
        ...
        for (let I = 0; I < totBT; I++) {
            Testo += "<div id='RifCopione" + DatiCopione[I].NumID + "' style='cursor: pointer;' data-numid='" + DatiCopione[I].NumID + "' onclick='FunzioneCopione.PosizionaVideo(event);'><br>" + DatiCopione[I].testo + "</div>";
        }
...
function RidimensionaTestoGuida_Attiva(e) {
    const DaModificare = {'LatoSx_TestoGuida': {style: 'left', CoordinatePuntatore: 'clientX', MisuraDiPartenza: 0}, 'LatoDx_TestoGuida': {style: 'right', CoordinatePuntatore: 'clientX', MisuraDiPartenza: +window.innerWidth}, 'ManigliaSposta_TestoGuida': {style: 'top', CoordinatePuntatore: 'clientY', MisuraDiPartenza: 0}, 'Base_TestoGuida': {style: 'bottom', CoordinatePuntatore: 'clientY', MisuraDiPartenza: +window.innerHeight}};
