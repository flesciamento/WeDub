...
function DividiClip_puntatorerilasciato(e) {
    ...
    function VisualizzaAttenderePrego(PulsanteSelezionato) {
        ...
        tdProcedi.innerText = strAttenderePrego; tdProcedi.className = 'alert alert-info';
    }
    ...
    const PannelloOpzioni = CreaElemento('div', 'OpzioniDividiClip', document.body.id);
        ...
        const divContenuto = CreaElemento('div', PannelloOpzioni.id + 'Contenuto', PannelloOpzioni.id); divContenuto.className = "panel-body text-center";
                var divContenitore = CreaElemento('div', 'DividiClip_ContenitorePulTagliaViaSelezionato', divContenuto.id); divContenitore.style.margin = "20px";
                    const pulTagliaViaSelezionato = CreaElemento('a', 'DividiClip_pulTagliaViaSelezionato', divContenitore.id, strTagliaViaSelezionato); pulTagliaViaSelezionato.className = 'btn btn-default';
                    ...
                    divContenitore = CreaElemento('div', 'DividiClip_ContenitorePulTagliaViaIlResto', divContenuto.id); divContenitore.style.margin = "20px";
                    const pulTagliaViaIlResto = CreaElemento('a', 'DividiClip_pulTagliaViaIlResto', divContenitore.id, strTagliaViaIlResto); pulTagliaViaIlResto.className = 'btn btn-default';
        ...
        const divPulsantiFinali = CreaElemento('div', PannelloOpzioni.id + 'PulsantiFinali', PannelloOpzioni.id); divPulsantiFinali.className = 'panel-footer';
            const Tabella = CreaElemento('table', PannelloOpzioni.id  + 'TabellaPulsantiFinali', divPulsantiFinali.id); Tabella.className = "TabellaOpzioni"; Tabella.style.width = "100%";
                const tr = CreaElemento('tr', PannelloOpzioni.id  + 'RigaTabellaPulsantiFinali', Tabella.id);
                    ...
                    const tdProcedi = CreaElemento('td', PannelloOpzioni.id + 'CasellaProcedi', tr.id);
}
