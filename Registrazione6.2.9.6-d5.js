...
function RiposizionamentoAutomaticoClipSovrapposte(ELTConsiderato) {
    if (ELTDaSpostare == false) {
        ...
        var NuoviELTDaRiordinare = [], ID_NuoviELTDaRiordinare = [];
        ...
        if (NuoviELTDaRiordinare[0] != ELTConsiderato) {console.log("Rimanda", NuoviELTDaRiordinare[0], ELTConsiderato); TrovaELTDaRiordinare(NuoviELTDaRiordinare[0]);}
        
        /* Effettua il riposizionamento */
        const totELTDaRiordinare = Object.keys(ID_NuoviELTDaRiordinare).length;
        ...
        if (totELTDaRiordinare > 0) {
            ...
            for(idELT in ID_NuoviELTDaRiordinare) {
                document.getElementById(idELT).iStyle({top: (altezzaclip * I) + "%", height: altezzaclip + "%"});
            }
        }
    }
}
