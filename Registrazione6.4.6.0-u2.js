...
function AggiornaRappresentazioneColonnaInternazionale() {
    ...
    divCIStato.style.backgroundImage = `linear-gradient(90deg, ${colorePorzioneTagliata} 0%, ${colorePorzioneTagliata} ${PercentualeMinutaggio(InizioVideo)} ${strSfondo} ${colorePorzioneTagliata} ${PercentualeMinutaggio(totDurataVideoGuida)} ${colorePorzioneTagliata} 100%)`;
