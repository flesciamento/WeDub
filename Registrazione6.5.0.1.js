...
function AttivaProgramma() {
    ...
    if (!ModalitaStreaming) {
        ...
        CreaElemento('div', 'divContenitoreSlideMinutaggio', 'VideoGuida', '', true).append(slideMinutaggioAttuale, ControlliInSovrimpressione);
...
function ControlliInSovrimpressione_Avanza(e) {
    ...
    Animazione(e.currentTarget.children[0], "rotazione-" + ((Secondi > 0) ? "destra" : "sinistra") + " 400ms ease 0s 2 alternate");
}
...
function ComandiPlayer_ScomparsaAutomatica() {
    ...
    tmrComandiPlayerModalitaStreaming = setTimeout(() => {ComandiPlayer.style.opacity = 0;}, 1000);
}
