...
function RiproduciClipInSync(MinutaggioVideo) {
    ...
    ClipDaRiprodurre.forEach((I) => {
        ...
        (ModalitaStreaming && (datiAudio.audio.onended = (e) => {const da = DatiAudioRegistrato[e.currentTarget.numero]; console.log("delete", da, da.numero); delete da.audio; delete da.buffer; da.RichiestoCaricamentoBuffer = false; console.log("deleted", da, da.audio, da.numero, da.buffer);}));
    });
