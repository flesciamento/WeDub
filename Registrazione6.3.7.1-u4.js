                    ...
                    td = CreaElemento('td', ID_Opzioni + 'tdOpzioneRiduciRumore', tr.id);
                        ...
                        pulRiduciRumore.onclick = (e) => {
                            ...
                            for (let I = 0; I < lunghezzaBuffer; I++) {
                                log += "\n" + b[I] + " -> " + (b[I] / TrattamentoClip.AutoTaglioIniziale.SogliaDB) + ", " + (b[I] * Math.min(b[I] / TrattamentoClip.AutoTaglioIniziale.SogliaDB, 1));
                                b[I] *= Math.min(b[I] / TrattamentoClip.AutoTaglioIniziale.SogliaDB, 1);
                            }
