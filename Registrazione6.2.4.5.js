...
function SwitchCopioneEditabile() {
    ...
    const s = TestoGuida.querySelectorAll("[data-battuta='1']"), tots = s.length, valore = (FunzioniCopione.CopioneEditabile? true : false);
    for (let I = 0; I < tots; I++) {
        s[I].setAttribute('contenteditable', valore);
    }
}
