...
async function Posizionati(MinutaggioNuovo, RiabilitaLaSchermata = true) {
    ...
    function RiabilitaLaSchermataSeRichiesto() {
        console.log("RiabilitaLaSchermataSeRichiesto()");
    ...
    pulPlay.disabled = true; PlayPausaCliccandoSulVideo(false); DisabilitaElementiRegistrazione(true); // Disabilita solo i comandi per riprodurre
