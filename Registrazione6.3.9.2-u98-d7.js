...
function VideoGuidaPronto() {
    ...
    CreaMenuADiscesa([
        {DoveInserirlo: 'OpzioniRegistrazione', ID_Contenitore: 'SelezioneCanaleRegistrazione',  ID_Menu: 'CanaleRegistrazione',  stili: 'float: left; font-size: 9px;', Elementi: [{dato: 0, stringa: strCanaleSx, predefinito: true}, {dato: 1, stringa: strCanaleDx}], FunzioneAlClick: AttivaIngressi},
        {DoveInserirlo: 'OpzioniRegistrazione', ID_Contenitore: 'SelezioneQualitaRegistrazione', ID_Menu: 'QualitaRegistrazione', stili: 'float: left; font-size: 9px;', Elementi: [{dato: 1, stringa: strQualitaAlta, predefinito: !CondizioneQualitaMedia}, {dato: 0, stringa: strQualitaMedia, predefinito: CondizioneQualitaMedia}], FunzioneAlClick: AttivaIngressi, SpiegazioneFunzioni: SpiegazioneQualitaRegistrazione}
    ]);
