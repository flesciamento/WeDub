const DatiCopione = [], PosizioneInizialeCopione = {top: "0px", left: "30%", right: "0px", bottom: "40%"};
...
const ContenitoreTestoGuida = CreaElemento('div', 'ContenitoreTestoGuida', document.body.it); ContenitoreTestoGuida.iStyle(PosizioneInizialeCopione);
