...
function DividiClip_puntatorerilasciatoFuori(e) {
    const ELT = ELTCliccato, datiAudio = DatiAudioRegistrato[ELT.dataset.RiferimentoRegistrazione], MinutaggioPrimoClick = MinutaggioCliccatoNellaClip(ELT, +ELT.dataset.posizionePuntatoreInizioTaglio), MinutaggioRilascio = ((e.clientX > +ELT.dataset.posizionePuntatoreInizioTaglio) ? datiAudio.taglioFinale : datiAudio.taglioIniziale);
    document.body.removeEventListener('mouseup', DividiClip_puntatorerilasciatoFuori); ELT.removeEventListener('mouseup', DividiClip_puntatorerilasciato);
...
function DividiClip_puntatorerilasciato(e) {
    ...
    ELT.removeEventListener('mouseup', DividiClip_puntatorerilasciato);
    ElaboraDivisioneClipRichiestaConPuntatore(ELT.dataset.RiferimentoRegistrazione, MinutaggioPrimoClick, MinutaggioRilascio);
}
...
function CreaElementoLineaTemporale(ID, DoveInserirlo, PartenzaRegistrazione, LunghezzaRegistrazione, Stringa, RiferimentoRegistrazione, Posizione, Altezza, imgOndaSonora, DaVisualizzare) {
	...
	if ( ( (DatiAudioRegistrato[RiferimentoRegistrazione].ID_Utente == ID_Utente) && (SolaVisione == false) ) || (SonoCreatoreProgetto)) {
        const datiAudio = DatiAudioRegistrato[RiferimentoRegistrazione];
        ...
        ELT.addEventListener('mousedown',
            function(e) {
                ...
                const NumeroAudio = ELTCliccato.dataset.RiferimentoRegistrazione;
        ...
        if (DaVisualizzare) {ContenutoELT.style.border = "3px dashed darkgreen"; datiAudio.alPlay = AJAXSalvaAudioAscoltato;}
