...
function ModificaPersonaggio(T, Personaggio) {
    ...
    if (Personaggio) {
        ...
        if (confirm(strVuoiEliminarePersonaggio)) {T.nextElementSibling.textContent = ""; T.innerHTML = "&nbsp;"; SalvaCopione(divContenitore, true, +NumeroSpanBattuta - 2, +spanBattuta.previousElementSibling.previousElementSibling.children.length + 2);} else {return;}
    }
}
