...
function RiproduciClipInSync(MinutaggioVideo) {
    ...
    ClipDaRiprodurre.forEach((I) => {
        ...
        datiAudio.audio.onended = () => {ScaricaMemoria_slow(); (datiAudio.altermine && datiAudio.altermine());};
...
function GeneraBufferCI(datiAudio, buffer, FunzioneAlTermine = () => {}) {
    ...
    function TerminaBufferCI() {
        if (TrovaSpezzoneVicino(datiAudio, 1)) {
            ...
            datiAudio.altermine = () => {if (ColonnaInternazionaleAttivata && RiproduzioneInCorso && (VideoGuidaMinutaggioCorrente() < (totDurataVideoGuida - 1))) {SwitchColonnaInternazionale(false);}};
        }
