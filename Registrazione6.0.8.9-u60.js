...
function EliminaEventiPuntatoreDividiClip(ELT) {
    ELT.removeEventListener('mousemove', AnteprimaSelezioneClip.Visualizza);        Righello.removeEventListener('touchmove', AnteprimaSelezioneClip.Visualizza);
                ...
                switch(StrumentoMouse) {
                    ...
                    case toolDividiClip:
                        ...
                        if ((datiAudio.taglioIniziale < MinutaggioSelezionatoClip) && (MinutaggioSelezionatoClip < datiAudio.taglioFinale)) {
                            ...
                            EliminaEventiPuntatoreDividiClip(ELT);
                            ELT.addEventListener('mousemove', AnteprimaSelezioneClip.Visualizza);       Righello.addEventListener('touchmove', AnteprimaSelezioneClip.Visualizza);
                            document.body.addEventListener('mouseup', DividiClip_puntatorerilasciato);  Righello.addEventListener('touchend', DividiClip_puntatorerilasciato);
                        }
                    break;
