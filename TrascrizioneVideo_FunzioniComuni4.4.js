...
CreaElemento('style', 'styleTestoGuida', document.body.id,
    `.TestoGuida-evidenziato {background-color: rgba(200, 255, 200); border-radius: 10px;}
     #ManigliaSposta_TestoGuida {width: fit-content; margin: 0px auto; cursor: pointer;}
...
const ManigliaSposta_TestoGuida = CreaElemento('div', 'ManigliaSposta_TestoGuida', 'ContenitoreTestoGuida'); ManigliaSposta_TestoGuida.className = 'fa fa-navicon'; ManigliaSposta_TestoGuida.onmousedown = SpostaTestoGuida_Attiva;
