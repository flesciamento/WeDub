...
function CreazioneClipPrimoCaricamento(Dati) {
    ...
    if (ModalitaStreaming) {
        ...
        for (I = 0; I < totClipAudioComplessive; I++) {
            NumeroTotaleAudioCaricamentoIniziale += +ClipDaPrecaricare(I, InizioVideoGuida, SecondiPrecaricamentoAlPlay);
        }
        Messaggio(strCaricamentoPrimeClip);
        PrecaricaClip(InizioVideoGuida, SecondiPrecaricamentoAlPlay, () => {AggiornaCaricamentoClip(true);}, {FunzioneAlTermineSingoloPrecaricamento: () => {AggiornaCaricamentoClip(true);}, SoloBuffer: true});
