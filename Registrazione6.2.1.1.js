...
async function TermineCaricamentoClip() {
    if (!CaricamentoInizialeTerminato) {
        ...
        Messaggio(strCaricamentoCompletato + "<br />" + (SessioneOspite? (Provino || ProgettoCompletato) ? strModalitaVisualizzazione + "<br />" : strNonHaiNessunRuolo + "<br />" + (!SonoCreatoreProgetto ? strPuoiSoloVisualizzare : "") : "") + (SonoCreatoreProgetto? "<span style='font-size: 13px; font-weight: bold; font-style: italic;'>" + strPoteriCreatoreProgetto + "</span>" : ""), "OK");
        await pausa(1000);
        if (ModalitaStreaming) {
