...
function SpostaTestoGuida(e) {
    ...
    ContenitoreTestoGuida.iStyle({top: Y + "px", left: (+X - ContenitoreTestoGuida.dataset.posizionedelmouse) + "px", right: ((ContenitoreTestoGuida.dataset.leftiniziale - ContenitoreTestoGuida.offsetLeft) - ContenitoreTestoGuida.dataset.rightiniziale) + "px", bottom: ((ContenitoreTestoGuida.dataset.topiniziale - ContenitoreTestoGuida.offsetTop) - ContenitoreTestoGuida.dataset.bottominiziale) + "px"});
}
