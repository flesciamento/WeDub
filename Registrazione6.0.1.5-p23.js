...
function PrecaricaClip(DalMinutaggio, FinoAlMinutaggio, FunzioneAlTermine = false, AltreOpzioni = {FunzioneAlTermineSingoloPrecaricamento: () => {}, SoloBuffer: false}) {
    ...
    if ((totClipDaPrecaricare == 0) && (FunzioneAlTerminePrecaricamento)) {FunzioneAlTerminePrecaricamento();} else {setTimeout(() => {MinutaggioPrecaricamentoClip = SecondiPrecaricamentoMax; PrecaricaClipSuccessiva();}, (SecondiPrecaricamentoMax / 2) * 1000);}
}
