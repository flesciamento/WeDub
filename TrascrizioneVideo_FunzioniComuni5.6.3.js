...
var FunzioniCopione = {
    ...
    RidimensionaTestoGuida_Disattiva: function () {
        ...
        if (ContenitoreTestoGuida.offsetHeight < soglia_altezza) {ContenitoreTestoGuida.style.height = soglia_altezza + "px"; ContenitoreTestoGuida.offsetHeight; ContenitoreTestoGuida.style.bottom = ((window.innerHeight - (ContenitoreTestoGuida.offsetTop - ContenitoreTestoGuida.offsetHeight)) / window.innerHeight * 100) + "%"; setTimeout(() => {ContenitoreTestoGuida.style.height = "";}, 100);}
        if (ContenitoreTestoGuida.offsetWidth  < soglia_larghezza) {ContenitoreTestoGuida.style.width = soglia_larghezza + "px"; ContenitoreTestoGuida.offsetWidth; ContenitoreTestoGuida.style.right = ((window.innerWidth - (ContenitoreTestoGuida.offsetLeft - ContenitoreTestoGuida.offsetWidth)) / window.innerWidth * 100) + "%";  setTimeout(() => {ContenitoreTestoGuida.style.width = "";}, 100);}
