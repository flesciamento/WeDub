    ...
    const PannelloOpzioni = CreaElemento('div', 'OpzioniDividiClip', document.body.id);
        ...
        const divContenuto = CreaElemento('div', PannelloOpzioni.id + 'Contenuto', PannelloOpzioni.id); divContenuto.className = "panel-body text-center";
            var divContenitore = CreaElemento('div', 'DividiClip_ContenitoreTagliaViaSelezionato', divContenuto.id);
                const pulTagliaViaSelezionato = CreaElemento('span', 'DividiClip_pulTagliaViaSelezionato', divContenitore.id, "<img style='float: left; height: 40px;' src='images/Esempio_taglio_segmento.png' /> " + strTagliaViaSelezionato); pulTagliaViaSelezionato.className = 'btn btn-default btn-lg'; pulTagliaViaSelezionato.iStyle({width: "100%", fontSize: "14pt", margin: "20px 0", lineHeight: 1.8});
            ...
            var divContenitore = CreaElemento('div', 'DividiClip_ContenitoreTagliaViaIlResto', divContenuto.id);
                const pulTagliaViaIlResto = CreaElemento('span', 'DividiClip_pulTagliaViaIlResto', divContenitore.id, "<img style='float: left; height: 40px;' src='images/Esempio_mantenimento_segmento.png' /> " + strTagliaViaIlResto); pulTagliaViaIlResto.className = 'btn btn-default'; pulTagliaViaIlResto.iStyle({width: "100%", fontSize: "14pt", margin: "20px 0", lineHeight: 1.8});
            ...
            if ((secondiInizioTaglio > taglioclip_diffmin) && (secondiFineTaglio < (DatiAudioRegistrato[ELT.dataset.RiferimentoRegistrazione].Durata - taglioclip_diffmin))) {
                var divContenitore = CreaElemento('div', 'DividiClip_ContenitoreCreaNuovaClip', divContenuto.id);
                    const pulCreaNuovaClip = CreaElemento('span', 'DividiClip_CreaNuovaClip', divContenitore.id, "<img style='float: left; height: 40px;' src='images/Esempio_mantenimento_segmento.png' /> " + strTagliaECreaNuovaClip); pulCreaNuovaClip.className = 'btn btn-default'; pulCreaNuovaClip.iStyle({width: "100%", fontSize: "14pt", lineHeight: 1.8});
                          pulCreaNuovaClip.onclick = (e) => {
                                const Numero = ELT.dataset.RiferimentoRegistrazione;
                                VisualizzaAttenderePrego(e.currentTarget);
                                DividiClip(Numero, secondiInizioTaglio, secondiInizioTaglio, "", (ClipNuova) => {if (ClipNuova) {DividiClip(ClipNuova.numero, secondiFineTaglio, secondiFineTaglio);}});
                          };
            }
