...
function CreaRegistrazione_wav() {
    const sampleRate = audioContext.sampleRate, sogliaDB_taglioiniziale = 0.1;
    ...
    leftBuffer = leftBuffer.slice(leftBuffer.indexOf(leftBuffer.find((a) => {return a > sogliaDB_taglioiniziale;}))); // taglio iniziale automatico
