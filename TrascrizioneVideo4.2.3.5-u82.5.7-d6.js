...
/*		case "(": NodoAttuale.textContent = NodoAttuale.textContent.slice(0, PosizioneCursore) + ")" + NodoAttuale.textContent.slice(PosizioneCursore); ; return 2;
        ...
        case "V":
        case "v": if (e.ctrlKey) {await pausa(100); console.log("incolla", ElementoAttuale); ElementoAttuale.innerHTML = ElementoAttuale.innerText; await pausa(100); const NuovoNodoAttuale = PosizioneDelCursore().nodo; PosizionaCursore(NuovoNodoAttuale, NuovoNodoAttuale.textContent.length - 1); return;}
        ...
        case "ArrowDown": if ((PosizioneCursore > NodoAttuale.textContent.length - 200) && (camposuccessivo = TrovaCampoTestoVicino(ElementoAttuale, 1))) {await pausa(100); camposuccessivo.focus();} console.log("giu", ElementoAttuale, camposuccessivo); return;
