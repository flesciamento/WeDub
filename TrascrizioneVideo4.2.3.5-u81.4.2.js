        ...
        case "Backspace":
            if (T.innerText.trim() == "") {
                ...
                if ((e.key == "Backspace") && (PosizioneCursore < 2)) {
                    ...
                    if ((NumeroSpanBattuta <= 2) && (NumeroSpan == 2)) {SalvaCopione(T, true); ( (div = document.getElementById('RifCopione' + (T.dataset.numid - 1))) && (div.lastElementChild.querySelector("[contenteditable='true']").focus()) ); return;}
