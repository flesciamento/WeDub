...
function GeneraBufferCI(datiAudio, buffer, FunzioneAlTermine = () => {}) {
    ...
    if ((datiAudio_SpezzonePrecedente = TrovaSpezzoneVicino(datiAudio, -1)) && (datiAudio_SpezzonePrecedente.buffer)) {
        ...
        datiAudio.buffer = appendBuffer([datiAudio_SpezzonePrecedente.buffer, b]);

        datiAudio.MinutaggioRegistrazione -= duratabufferspezzoneprec;
        datiAudio.taglioIniziale = duratabufferspezzoneprec - tempomixBufferPrec;
    } else {
        datiAudio.buffer = b;
    }
