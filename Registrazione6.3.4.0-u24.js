...
function GeneraBufferCI(datiAudio, buffer, FunzioneAlTermine = () => {}) {
    ...
    const b = buffer, SampleRate = b.sampleRate, numCanali = b.numberOfChannels, tempomixBufferPrec = 0.1, lunghezzabytetempomix = SampleRate * tempomixBufferPrec;
    ...
    function TerminaBufferCI() {
        if (TrovaSpezzoneVicino(datiAudio, 1)) {
            ...
            datiAudio.latenzaEventoAlPlay = {secondi: datiAudio.Durata - 0.1, riduciSeClipNelMinutaggio: true};
        }
