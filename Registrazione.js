    ...
    CreaNuoviElementi({
        [ID_Opzioni]: [['div', {id: 'OpzioniTitolo', className: "panel-heading text-center"}, {userSelect: "none"}]],
            OpzioniTitolo: [
                ...
                ['a', {id: ID_Opzioni + 'Cancella', className: (AudioAttivo? 'btn btn-danger fa fa-trash-o' : 'btn btn-info fa fa-undo'), title: (AudioAttivo? strCancellaClip : strRipristinaClip), onclick: function (e) {CancellaRipristinaRegistrazione(e.currentTarget.dataset.RiferimentoRegistrazione, AudioAttivo);}}, {position: "absolute", top: "5px", left: "10px"},   {RiferimentoRegistrazione: RiferimentoRegistrazione}],
