...
function CreaNuovaTextarea(NumID, Minutaggio) {
    ...
    const tr = CreaElemento('tr', 'RigoBloccoTesto' + NumRigo, "ContenitoreTesto");
            td = CreaElemento('td', 'tdInfoMinutaggio' + NumRigo, tr.id); td.iStyle({width: "50px", backgroundColor: "white", textAlign: "center", verticalAlign: "top", fontSize: "80%"});
                    /** Minutaggio **/
                    ...
                    M = CreaElemento('span', 'MinutaggioMinuti' + NumRigo, td.id, MinutaggioAttuale.Minuti || "0"); M.iStyle({width: "fit-content", textAlign: "right"});
