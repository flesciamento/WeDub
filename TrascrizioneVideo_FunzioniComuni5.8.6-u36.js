...
var FunzioniCopione = {
    ...
    Visualizza: function () {
        ...
        const FunzioniNomePersonaggio = ((FunzioniCopione.CopioneEditabile == 2) ? " class='btn-default' onclick='FunzioniCopione.FunzioneModificaPersonaggio(event)'" : ""), TestoEditabile = ((FunzioniCopione.CopioneEditabile > 0) ? " contenteditable='true' onkeydown='FunzioniCopione.FunzioneModificaBattuta(event);' onclick='FunzioniCopione.FunzioneOnClickBattuta(event);'" : "");
