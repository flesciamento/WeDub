...
function CreaFinestraOpzioniClip(RiferimentoRegistrazione) {
    ...
    const divcontenitorebody = CreaElemento('div', ID_Opzioni + 'ContenitoreOpzioniBody', ID_Opzioni); divcontenitorebody.className = "panel-body";
        ...
        if (SonoCreatoreProgetto) {
            const pulDaAscoltare = CreaElemento('label', ID_Opzioni + 'labelPulDaAscoltare', divcontenitorebody.id, "<input type='checkbox' " + (datiAudio.daVisualizzare? "checked" : "") + "> " + strDaAscoltare); pulDaAscoltare.className = "btn btn-default btn-xs"; pulDaAscoltare.iStyle({position: "absolute", marginLeft: "2px"}); pulDaAscoltare.setAttribute('title', strDaAscoltare_title);
