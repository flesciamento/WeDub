...
function DividiClip_puntatorerilasciatoFuori(e) {
    const ELT = ELTCliccato, datiAudio = DatiAudioRegistrato[ELT.dataset.RiferimentoRegistrazione], MinutaggioPrimoClick = MinutaggioCliccatoNellaClip(ELT, +ELT.dataset.posizionePuntatoreInizioTaglio), MinutaggioRilascio = (((e.clientX + window.scrollX - ContenitoreRighello.offsetLeft) > +ELT.dataset.posizionePuntatoreInizioTaglio) ? datiAudio.taglioFinale : datiAudio.taglioIniziale);
    document.body.removeEventListener('mouseup', DividiClip_puntatorerilasciatoFuori);
