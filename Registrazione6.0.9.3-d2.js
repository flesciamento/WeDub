...
function GestioneEventoELTCliccato(e) {
    ...
    console.log("Entrato in GestioneEventoELTCliccato()", e);
    e.stopPropagation(); // Impedisce di attivare l'evento mousedown del righello.
    console.log("dopo stopPropagation()");
...
function GestioneEventoCommentoELTCliccato(e) {
    ...
    console.log("GestioneEventoCommentoELTCliccato()", e, Object.assign({}, e, {currentTarget: document.getElementById('ELTReg' + e.currentTarget.dataset.RiferimentoRegistrazione + 'StratoColore')}));
