...
function DividiClip_puntatorerilasciato(e) {
    ...
    function VisualizzaAttenderePrego(PulsanteSelezionato) {
        ...
        pulAnnulla.innerHTML = strAttenderePrego; pulAnnulla.className = 'btn btn-default btn-lg';
    }
...
function AnteprimaSelezioneClip(ELT, ClientX) {
    ...
    AnteprimaSelezioneClip.Visualizza = (e) => {
        ...
        div.iStyle({width: Math.abs(PosizioneMouse) + "px", transform: ((PosizioneMouse > 0) ? "" : "translate(-100%, 0)")});
        console.log('log_AnteprimaSelezioneClip', PosizioneMouse > 0, div.style.transform);
    };
