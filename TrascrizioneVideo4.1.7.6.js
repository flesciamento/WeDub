	...
	AJAX("TrascrizioneVideo_CaricaCopione.php", "N=" + encodeURIComponent(N),
        async function (Dati) {
                ...
                for (let I = 0; I < totBlocchiDiTesto; I++) {
                    ...
                    void T.offsetHeight;
                    AdattaAltezzaTextarea_MemorizzaTesto({currentTarget: T});
                    VisualizzaProgressoBarraCaricamento(BarraCaricamento, I / totBlocchiDiTesto);
                    await pausa(10);
                }
...
function PartenzaProgramma() {
    ...
    document.getElementById('pannelloContenitoreInfo').append(divAJAX); divAJAX.style.position = "static";
