...
function CaricaColonnaInternazionale(Dati) {
    ...
    /* Arriverà così dal database */
    Dati = {Registrazione: "ColonneAudio/263_1661254444_CIspezzone000.ogg,ColonneAudio/263_1661254444_CIspezzone001.ogg,ColonneAudio/263_1661254444_CIspezzone002.ogg,ColonneAudio/263_1661254444_CIspezzone003.ogg,ColonneAudio/263_1661254444_CIspezzone004.ogg,ColonneAudio/263_1661254444_CIspezzone005.ogg,ColonneAudio/263_1661254444_CIspezzone006.ogg,ColonneAudio/263_1661254444_CIspezzone007.ogg,ColonneAudio/263_1661254445_CIspezzone008.ogg,ColonneAudio/263_1661254445_CIspezzone009.ogg,ColonneAudio/263_1661254445_CIspezzone010.ogg,ColonneAudio/263_1661254445_CIspezzone011.ogg,ColonneAudio/263_1661254445_CIspezzone012.ogg,ColonneAudio/263_1661254445_CIspezzone013.ogg,ColonneAudio/263_1661254445_CIspezzone014.ogg,ColonneAudio/263_1661254445_CIspezzone015.ogg,ColonneAudio/263_1661254445_CIspezzone016.ogg", volume: Dati.volume};
    ...
    function CaricaSpezzoneSuccessivo() {
        CreaNuovaClipAudio({Registrazione: SpezzoniAudioCI[NumSpezzone], N: (NumSpezzone + 1) * -1, ID_Utente: 'CI', MinutaggioRegistrazione: 75 * NumSpezzone, TaglioIniziale: 0, Guadagno: Dati.volume},
            (datiAudio) => {
                /* Fade-in primo secondo */
                const b = datiAudio.buffer, SampleRate = b.sampleRate;
                ...
                if (SpezzoneSuccessivo = SpezzoniAudioCI[++NumSpezzone]) {
                    CaricaAudio(0, SpezzoneSuccessivo, 'arraybuffer',
                        (Contenuto) => {
                            audioContext.decodeAudioData(Contenuto).then(
                                (bufferSucc) => {
                                    ...
                                    for(c = 0; c < bufferSucc.numberOfChannels; c++) {
                                        ...
                                        for(s = 1; s < SampleRateSucc; s++) {
                                            bufferCanale[s] *= (SampleRateSucc - s) / SampleRateSucc;
                                        }
                                    }

                                    datiAudio.buffer = appendBuffer([b, bufferSucc]);
                                    datiAudio.Durata = datiAudio.buffer.duration;
                                    datiAudio.taglioFinale += 1;
