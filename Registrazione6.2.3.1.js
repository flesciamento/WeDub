        ...
        switch(StrumentoMouse) {
            case toolStandard:
                ...
                if (SingoloELTDaModificare) {
                    /* Resetta la finestra delle opzioni per settarla sull'unica clip selezionata */
                    EliminaElemento(document.getElementById(ID_Opzioni));
                    CreaFinestraOpzioniClip(ELTDaModificare[0].dataset.numero);
