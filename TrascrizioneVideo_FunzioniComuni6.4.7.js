...
var FunzioniCopione = {
    ...
    EvidenziaPersonaggio: function (e) {
        ...
        if (!RiproduzioneInCorso && !document.querySelector(`.${FunzioniCopione.ClasseEvidenziaBattuta} [name="Battuta_${PersonaggioDaEvidenziare}"]`)) {FunzioniCopione.PosizionatiBattutaPersonaggio();}
    },
    /***************************/
