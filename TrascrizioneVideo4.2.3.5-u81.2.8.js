        ...
        case "Backspace":
            if (T.innerText.trim() == "") {
                ...
                if ((e.key == "Backspace") && (PosizioneCursore < 2)) {
                    ...
                    ElementoAttuale.previousElementSibling.previousElementSibling.innerHTML = "&nbsp;";
                    EliminaElemento(ElementoAttuale.previousElementSibling.previousElementSibling.previousElementSibling);
                    SalvaCopione(T, true, NumeroChildren(T, spanBattuta), NumeroChildren(spanBattuta, ElementoAttuale) - 3);
                    return;
                }
            }
            break;
