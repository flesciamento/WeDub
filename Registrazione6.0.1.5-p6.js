...
function AttivaProgramma() {
    ...
    setTimeout(() => {
        ...
        VideoGuidaPause(); ImpostaStatoPlay(false); VideoGuidaPosizionati(0); slideMinutaggioAttuale.value = 0; setTimeout(() => {ImpostaVolumeVideoGuida(vol);}, 1000);
...
function RiproduciClipInSync(MinutaggioVideo) {
    ...
    ClipDaRiprodurre.forEach((I) => {
        ...
        (ModalitaStreaming && (datiAudio.audio.onended = (e) => {const da = DatiAudioRegistrato[e.currentTarget.numero]; console.log("delete", da, da.numero); delete da.buffer; delete da.audio; console.log("deleted", da, da.audio, da.numero, da.buffer);}));
    });
