...
var FunzioniCopione = {
    ...
    Visualizza: function () {
        ...
        for (let I = 0; I < totBT; I++) {
            Testo += "<div id='RifCopione" + DatiCopione[I].NumID + "' style='cursor: pointer;' data-numid='" + DatiCopione[I].NumID + "' onclick='FunzioniCopione.PosizionaVideo(event);'><br>" + DatiCopione[I].testo + "</div>";
        }
