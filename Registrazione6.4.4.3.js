...
function CI_DisattivaAudioOriginaleAlPlay(datiAudio) {
    datiAudio.alPlay.push({FunzioneAlPlay: CI_DisattivaAudioOriginale, latenzaEventoAlPlay: {secondi: 0.1, riduciSeClipNelMinutaggio: false}});
}
...
function CalcolaVolumeAudioOriginale(Volume) {
    return Volume * (AudioBufferColonnaInternazionale.length ? GuadagnoPrincipale[AudioBufferColonnaInternazionale[0].numero].gain.value : 1);
}
