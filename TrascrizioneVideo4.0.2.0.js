...
function CreaNuovaTextarea(Minutaggio) {
    ...
    const tr = CreaElemento('tr', 'tr' + NumRigo, "ContenitoreTesto");
            td = CreaElemento('td', 'tdInfoMinutaggio' + NumRigo, tr.id); td.iStyle({width: "120px", backgroundColor: "white", textAlign: "center"});
                    M = CreaElemento('input', 'MinutaggioMinuti' + NumRigo, td.id); M.setAttribute("type", "number"); M.style.width = "50px";
                    ...
                    CreaElemento('a', 'pulPlay' + NumRigo, td.id, "<span class='fa fa-play-circle'></span> Play").className = 'btn btn-default btn-xs';
