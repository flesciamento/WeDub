...
/* 		case "Control": if (e.location == 2) {RiprendiDaPocoPrima(6);} */
		...
		case "Enter":
            ...
            if (textareasuccessiva = document.getElementById('t' + (+T.dataset.NumRigo + 1))) {
                console.log(textareasuccessiva, Minutaggio, textareasuccessiva.dataset.minutaggio, Minutaggio < textareasuccessiva.dataset.minutaggio);
