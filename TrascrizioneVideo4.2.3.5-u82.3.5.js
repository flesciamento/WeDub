            ...
            CreaListaMenu(DatiPersonaggi, inputSceltaPersonaggio,
                ...
                () => {
                    ...
                    if (NuovoPersonaggio) {
                        ...
                        /* In caso di nessuna scelta (stringa vuota), verifica se si tratta di modifica del personaggio esistente */
                        if (RichiestaModificaPersonaggio) {
                            if (PersonaggioDaModificare != "") {
                                /* Se c'era un personaggio da modificare, rimette lo stesso */
                                FunzioneAllaSceltaPersonaggio(T, PersonaggioDaModificare);
                            } else {
                                /* Se non c'era un personaggio da modificare, esce */
...
async function ScriviPersonaggio(T, Personaggio) {
    ...
    if (Personaggio) {
        ...
        PosizionaCursore(PosizioneDelCursore().nodo, 0, 1);
    }
