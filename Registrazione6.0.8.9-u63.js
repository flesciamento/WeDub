...
function AnteprimaSelezioneClip(ELTConsiderato, ClientX) {
    ...
    if (SistemaAttualeAndroid) {divCartello = CreaElemento('div', 'divCartello' + div.id, Righello.id, strCliccaQuiPerConfermareSelezione); divCartello.className = 'alert alert-info'; divCartello.iStyle({position: "fixed", zIndex: 1000000000, top: "100px", left: "35%", fontWeight: "bold", fontSize: "16pt", userSelect: "none"});}
