...
function AttivaProgramma() {
    ...
    if (!ModalitaStreaming) {
        ...
        setTimeout(() => {
            ...
            if (RuoliDaAssegnare_NumeroTraccia !== false) {VariaAltezzaTraccia(RuoliDaAssegnare_NumeroTraccia, (+document.getElementById('divContenutoNomeTraccia' + RuoliDaAssegnare_NumeroTraccia).offsetHeight) + (85 * SonoCreatoreProgetto)); SpostaInBassoTracceSuccessive();}
