...
var FunzioniCopione = {
    ...
    Visualizza: function () {
        ...
        TestoGuida.innerHTML = "<span>" + Testo.replace(/\n/g, '<br>').replace(new RegExp('<br>([' + PatternRegexNomePersonaggio + ']+): ', 'g'), `</span><br style='line-height: 5px;'><span data-battuta='1' name=\"Battuta_$1\"><b ${FunzioniNomePersonaggio}>$1</b>:<span> </span><span ${TestoEditabile}>`) + "</span></span><br style='line-height: 4vh;' />";
        /******************************/
    ...
    Eventi: function (Attiva) {
        ...
        ManigliaSposta_TestoGuida.style.display = LatoSx_TestoGuida.style.display = LatoDx_TestoGuida.style.display = Base_TestoGuida.style.display = (FunzioniCopione.Ridimensionabile? 'none' : '');
    },
    /*******************************/
