        ...
        (Dati) => {
            ...
            for (let I = 0; I < totMarcatori; I++) {
                ...
                if (Marcatore = document.getElementById('Marcatore' + M.NumMarcatore)) {
                    ...
                    Casella.value = M.TestoMarcatore; Casella.dataset.valoreprec = M.TestoMarcatore;
                } else {
            ...
            CaricaMarcatori.MarcatoriPrec.forEach((I, IDMarcatore) => {console.log('Marcatore', IDMarcatore); if (!CaricaMarcatori.Marcatori[IDMarcatore]) {EliminaElemento(document.getElementById('Marcatore' + IDMarcatore));}});
