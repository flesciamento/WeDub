...
function CaricaColonnaInternazionale(Dati) {
    ...
    function CaricaSpezzoneSuccessivo() {
        CreaNuovaClipAudio({Registrazione: SpezzoniAudioCI[NumSpezzone], N: (NumSpezzone + 1) * -1, ID_Utente: 'CI', MinutaggioRegistrazione: 74.91918367346939 * NumSpezzone, TaglioIniziale: 0, TaglioFinale: 75, Guadagno: Dati.volume},
            (datiAudio) => {
                            ...
                            audioContext.decodeAudioData(Contenuto).then(
                                (bufferSucc) => {
                                    ...
                                    for(c = 0; c < bufferSucc.numberOfChannels; c++) {
                                        ...
                                        bufferCanale = bufferCanale.slice(0, SampleRateSucc);
                                    }
