...
/* 		case "Control": if (e.location == 2) {RiprendiDaPocoPrima(6);} */
        ...
        case "ArrowDown": ((PosizioneCursore > (T.value.length - 20))) && (textareasuccessiva = document.getElementById('t' + (+T.dataset.rifRigo + 1))) && (textareasuccessiva.focus()); break;
		case "Enter":
...
function CreaNuovaTextarea(Minutaggio) {
    ...
    const tr = CreaElemento('tr', 'tr' + NumRigo, "ContenitoreTesto");
            ...
            td = CreaElemento('td', 'tdTesto' + NumRigo, tr.id);
                ...
                NuovaTextarea.addEventListener('keyup', SospendiVideo);
