...
function slide_AnteprimaMinutaggio(e) {
    ...
    divAnteprimaMinutaggioSlide.iStyle({display: "", left: ((+slideMinutaggioAttuale.offsetLeft) + (+e.offsetX)) + "px"}); divAnteprimaMinutaggioSlide.textContent = M.Minuti + ":" + M.Secondi.toFixed(0).padStart(2, "0");
}
