...
function leGeneraBufferCI(datiAudio, buffer, FunzioneAlTermine = () => {}) {
    ...
    if ((datiAudio_SpezzonePrecedente = TrovaSpezzoneVicino(datiAudio, -1)) && (datiAudio_SpezzonePrecedente.buffer)) {
        datiAudio.buffer = appendBuffer([datiAudio_SpezzonePrecedente.buffer, buffer]);
    ...
    console.log("Spezzone CI", datiAudio.numspezzoneCI, "durata", datiAudio.Durata);
