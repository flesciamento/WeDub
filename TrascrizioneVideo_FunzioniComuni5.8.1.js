...
var FunzioniCopione = {
    ...
    Visualizza: function () {
        ...
        TestoGuida.innerHTML = "<span>" + Testo.replace(/\n/g, '<br>').replace(new RegExp('<br>([' + PatternRegexNomePersonaggio + ']+):', 'g'), "</span><br style='line-height: 5px;'><span data-battuta='1' name=\"Battuta_$1\"><b>$1</b>:") + "</span><br style='line-height: 4vh;' />";
    ...
    Eventi: function (Attiva) {
        const OpzSposta_TestoGuida = document.getElementById('OpzSposta_TestoGuida'), OpzEvidenzia_TestoGuida = document.getElementById('OpzEvidenzia_TestoGuida'), OpzRiduciTesto_TestoGuida = document.getElementById('OpzRiduciTesto_TestoGuida'), OpzAumTesto_TestoGuida = document.getElementById('OpzAumTesto_TestoGuida');
        OpzSposta_TestoGuida.onmousedown = OpzSposta_TestoGuida.ontouchstart = (Attiva? FunzioniCopione.SpostaTestoGuida_Attiva : '');
        OpzEvidenzia_TestoGuida.onkeyup = (Attiva? FunzioniCopione.EvidenziaPersonaggio_keyup : '');
    ...
    EvidenziaPersonaggio: function (e) {
        ...
        for (let I = 0; I < totbattute; I++) {
            battute[I].iStyle({fontWeigth: 'bold', color: 'darkblue'});
        }
    },
    /***************************/
