...
async function Posizionati(MinutaggioNuovo, RiabilitaLaSchermata = true) {
    ...
    async function RiattivaVideoGuida() {
        ...
        await pausa(500);
        if ((VideoGuidaMinutaggioCorrente() | 0) != (MinutaggioNuovo | 0)) {setTimeout(() => {Posizionati(MinutaggioNuovo + 0.1, RiabilitaLaSchermata);}, 100); return;} // Se si incanta prova a riposizionarsi leggermente più avanti
