...
function DividiClip_puntatorerilasciato(e) {
    ...
    const PannelloOpzioni = CreaElemento('div', 'OpzioniDividiClip', document.body.id);
        ...
        const divContenuto = CreaElemento('div', PannelloOpzioni.id + 'Contenuto', PannelloOpzioni.id); divContenuto.className = "panel-body text-center";
            const pulTagliaViaSelezionato = CreaElemento('div', 'DividiClip_pulTagliaViaSelezionato', divContenuto.id, "<img style='float: left; height: 40px;' src='images/Esempio_taglio_segmento.png' />" + strTagliaViaSelezionato); pulTagliaViaSelezionato.className = 'btn btn-default btn-lg'; pulTagliaViaSelezionato.iStyle({width: "100%", fontSize: "15pt", lineHeight: 1.8});
            ...
            const pulTagliaViaIlResto = CreaElemento('a', 'DividiClip_pulTagliaViaIlResto', divContenuto.id, "<img style='float: left; height: 40px;' src='images/Esempio_mantenimento_segmento.png' />" + strTagliaViaIlResto); pulTagliaViaIlResto.className = 'btn btn-default'; pulTagliaViaIlResto.iStyle({width: "100%", fontSize: "13pt", lineHeight: 1.8});
