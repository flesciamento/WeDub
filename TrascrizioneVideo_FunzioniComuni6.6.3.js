const PosizioneDefaultCopione = {top: "15%", left: "8%", right: "63%", bottom: "45%", fontSize: "14px", lineHeight: "14px"};
var DatiCopione = [];
...
if (typeof NonCaricarePosizioneCopione == 'undefined') {setTimeout(() => {AJAX("TrascrizioneVideo_CaricaPosizioneCopione.php", "", (Dati) => {if (!Dati.NessunaPosizioneSalvata) {ContenitoreTestoGuida.iStyle(Object.assign({}, PosizioneDefaultCopione, Dati)); ContenitoreTestoGuida.style.lineHeight = ContenitoreTestoGuida.style.fontSize;}}, "", "", true);}, 100);}
/**********************************************/
