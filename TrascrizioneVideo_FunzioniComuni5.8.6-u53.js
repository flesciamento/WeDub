...
var FunzioniCopione = {
    ...
    PosizionaVideo: function (e) {
        ...
        if ((FunzioniCopione.CopioneEditabile > 0) && (BloccoTestoCliccato.innerText.trim() == "")) {BloccoTestoCliccato.children[0].querySelector("[contenteditable='true']").focus();}
