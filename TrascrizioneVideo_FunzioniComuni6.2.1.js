...
const FunzioniCopione = {
    ...
    AggiornaTestoGuida: function (MinutaggioAttuale = VideoGuidaMinutaggioCorrente()) {
        ...
        ((PosizioneCopione) && (SezioneTesto = document.getElementById('RifCopione' + PosizioneCopione.NumID)) && (SezioneTesto.className = FunzioniCopione.ClasseEvidenziaBattuta) && (FunzioniCopione.ScorrimentoAutomatico) && (ContenitoreTestoGuida.scrollTo({Top: SezioneTesto.offsetTop - (ContenitoreTestoGuida.offsetHeight / 2), behavior: 'smooth'})));
