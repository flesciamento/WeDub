...
function RideterminaLimitiAltezzaTracce() {
    AltezzaTracceMinima = (+window.innerHeight * 0.4) + (+ComandiPlayer.offsetHeight); AltezzaTracceMassima = window.innerHeight - SuddivisioneTracce - 25;
}
/********************************************************/
    ...
    if (!ModalitaStreaming) {
        ...
        setTimeout(() => {
            ...
            if (RuoliDaAssegnare_NumeroTraccia !== false) {
                ...
                if (!SonoCreatoreProgetto && !SessioneOspite) {AltezzaTracce = window.innerHeight - (Provino? (window.innerHeight * 0.4) : NomiTracce.children[0].offsetHeight) - 200; VariaAltezzaTracce();} // Ingrandisce lo spazio dedicato al video per i doppiatori
            }
