...
var FunzioniCopione = {
    AggiornaTestoGuida: function (MinutaggioAttuale = VideoGuidaMinutaggioCorrente()) {
        ...
        if (PosizioneCopione) {document.getElementById('RifCopione' + PosizioneCopione.NumID).scrollIntoView({behavior: 'smooth'});}
    ...
    Visualizza: function () {
        ...
        for (let I = 0; I <= totBT; I++) {
            Testo += "<a id='RifCopione" + DatiCopione[I].NumID + "'></a><br>" + DatiCopione[I].testo;
        }
