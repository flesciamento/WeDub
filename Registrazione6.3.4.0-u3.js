...
function CreaRegistrazione_wav() {
    const sampleRate = audioContext.sampleRate, sogliaDB_taglioiniziale = 0.04;
    ...
    taglioiniziale = leftBuffer.indexOf(leftBuffer.find((a) => {return a > sogliaDB_taglioiniziale;})) - (1 * sampleRate);
