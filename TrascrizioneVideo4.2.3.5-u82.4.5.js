 ...
 */
    ...
    if (PosizionaInfoTasti.Elemento) {PosizionaInfoTasti.Elemento.iStyle({marginTop: '', border: ''});}
    divContenitore.iStyle({marginTop: "25px", border: "1px solid blue"});
...
function PosizionaInfoTasti() {
    divInfoTasti.iStyle({top: (PosizionaInfoTasti.Elemento.getBoundingClientRect().y - 20) + "px"});
}
