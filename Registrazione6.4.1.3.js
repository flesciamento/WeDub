...
function VideoGuidaPronto() {
    ...
    CreaMenuADiscesa([
        {DoveInserirlo: 'OpzioniRegistrazione', ID_Menu: 'CanaleRegistrazione',  stiliContenitore: {float: "left"}, stiliMenu: {fontSize: "10px"}, Elementi: [{dato: 0, stringa: strCanaleSx, predefinito: (DatiMicPreferito[IdentificativoPiattaforma].canale == 0)}, {dato: 1, stringa: strCanaleDx, predefinito: (DatiMicPreferito[IdentificativoPiattaforma].canale == 1)}], FunzioneAlClick: () => {DatiMicPreferito[IdentificativoPiattaforma].canale = AcquisisciCanaleRegistrazione(); SalvaMicrofonoSelezionato(); AttivaIngressi();}},
