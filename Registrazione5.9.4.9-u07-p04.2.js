...
function CaricaColonnaInternazionale(Dati) {
    ...
    SpezzoniAudioCI.forEach((SpezzoneAudio, NumSpezzone) => {
        CreaNuovaClipAudio({Registrazione: SpezzoneAudio, N: -1, ID_Utente: 'ColonnaInternazionale', MinutaggioRegistrazione: 74.91918367346939 * NumSpezzone, TaglioIniziale: 0, TaglioFinale: 75, DurataRegistrazione: 75, Guadagno: Dati.volume}, "", false);
    });
