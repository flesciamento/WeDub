...
async function TermineCaricamentoClip() {
    if (!CaricamentoInizialeTerminato) {
        ...
        Messaggio(strCaricamentoCompletato + (!ModalitaStreaming ? "<br />" + (SessioneOspite? (Provino || ProgettoCompletato) ? "<span style='font-size: 12px'; font-style: italic;'>" + strModalitaVisualizzazione + "</span><br />" : strNonHaiNessunRuolo + "<br />" + (!SonoCreatoreProgetto ? strPuoiSoloVisualizzare : "") : "") + (SonoCreatoreProgetto? "<span style='font-size: 13px; font-weight: bold; font-style: italic;'>" + strPoteriCreatoreProgetto + "</span>" : "") : ""), "OK");
        await pausa(1000);
        if (ModalitaStreaming) {
