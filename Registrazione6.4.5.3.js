...
function ProcessaAudio_Monitora(e) {
   ...
   media = sum / totInput;
   const valore = (media / 2) + ((lentezzaLivelloMic * ProcessaAudio_Monitora.valoreprec) / 2);
...
function CreazioneClipPrimoCaricamento(DatiClipAudio) {
    ...
    if (PresenteColonnaInternazionale) {
        ...
        if (DatiCI[0].VolumeVideoGuida > 0) {ColonnaInternazionaleAttivata = true;} // Se è prevista esclusivamente la colonna originale, la attiva dall'inizio.
