...
function ContrassegnaClipDaAscoltare(datiAudio) {
    if (datiAudio.daAscoltare) {
        ...
        datiAudio.alPlay = [{FunzioneAlPlay: AJAXSalvaAudioAscoltato, latenzaEventoAlPlay: {secondi: datiAudio.taglioFinale - datiAudio.taglioIniziale - 2, riduciSeClipNelMinutaggio: true}}];
    };
}
