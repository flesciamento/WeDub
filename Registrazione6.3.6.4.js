    ...
    const PannelloOpzioni = CreaElemento('div', 'OpzioniDividiClip', document.body.id);
        ...
        const divContenuto = CreaElemento('div', PannelloOpzioni.id + 'Contenuto', PannelloOpzioni.id); divContenuto.className = "panel-body text-center";
            ...
            var divContenitore = CreaElemento('div', 'DividiClip_ContenitoreTagliaViaIlResto', divContenuto.id);
                const pulTagliaViaIlResto = CreaElemento('span', 'DividiClip_pulTagliaViaIlResto', divContenitore.id, "<img style='float: left; height: 40px;' src='images/Esempio_mantenimento_segmento.png' /> " + strTagliaViaIlResto); pulTagliaViaIlResto.className = 'btn btn-default'; pulTagliaViaIlResto.iStyle({width: "100%", fontSize: "14pt", lineHeight: 1.8});
