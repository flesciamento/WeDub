...
window.setTimeout(CaricamentoVideo, 2000); tmrCaricamento = window.setInterval(CaricamentoVideo, 10000); window.setTimeout(() => {const imgLogoWEDUB = document.getElementById('imgLogoWEDUB'); imgLogoWEDUB.src = "assets/img/" + LogoPrincipale; imgLogoWEDUB.parentNode.style.marginRight = (larghezzaLogo / 2) + "px"; imgLogoWEDUB.setAttribute('width', larghezzaLogo)}, secondiCambioLogo);
