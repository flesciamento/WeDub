...
CreaElemento('style', 'styleTestoGuida', document.body.id,
    `.TestoGuida-evidenziato {background-color: rgba(200, 255, 200); border-radius: 10px;}
     #ManigliaSposta_TestoGuida {position: sticky; top: 0px; width: 100%; font-size: 1.5vh; z-index: 1; text-align: center; background-color: rgba(255, 255, 255, 0.5);}
     ...
     #TestoGuida {position: relative; top: 1.5vh;}`
);
...
const ManigliaSposta_TestoGuida = CreaElemento('div', 'ManigliaSposta_TestoGuida', 'ContenitoreTestoGuida', "<span class='fa fa-navicon' style='cursor: move;'></span>"); ManigliaSposta_TestoGuida.children[0].onmousedown = SpostaTestoGuida_Attiva;
