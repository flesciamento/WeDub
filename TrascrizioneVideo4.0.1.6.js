...
function CreaNuovaTextarea(Minutaggio) {
    ...
    const tr = CreaElemento('tr', 'tr' + NumRigo, "ContenitoreTesto");
            td = CreaElemento('td', 'tdInfoMinutaggio' + NumRigo, tr.id); td.iStyle({width: "100px", backgroundColor: "white"});
                    M = CreaElemento('input', 'MinutaggioMinuti' + NumRigo, td.id); M.setAttribute("type", "number"); M.style.width = "60px";
                    ...
                    S = CreaElemento('input', 'MinutaggioSecondi' + NumRigo, td.id); S.setAttribute("type", "number"); S.style.width = "50px";
                    S.setAttribute("min", "0"); S.setAttribute("max", "59"); S.setAttribute("step", "1");
