...
function SelezionaESpostaELT(NumeroAudio, X = 0) {
    ...
    if (SingoloELTDaModificare) {
        ...
        StoppaAutomaticamenteAscoltoInSolo();  console.log("StoppaCicloClip in SelezionaESpostaELT"); StoppaCicloClip();                              // Stoppa l'eventuale ascolto in solo o la clip in ciclo
...
function StoppaCicloClip() {
    console.log("StoppaCicloClip()", ClipInCiclo);
    if (ClipInCiclo) {
        console.log("Superato if");
        ClipInCiclo.alTermine = () => {};
        console.log("eliminata funzione alTermine");
        ClipInCiclo = false;
        console.log("ClipInCiclo = false");
        StopVideoGuida();
        console.log("StopVideoGuida() fatto");
    }
}
/********************************/
