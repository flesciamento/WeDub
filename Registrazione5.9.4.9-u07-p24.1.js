...
var ColonnaInternazionale = false, ColonnaInternazionaleAttivata = false, SpezzoniAudioCI = [];
...
function CaricaBufferAudio(Numero, FunzioneAlTermine = () => {}, SoloBuffer = false) {
    ...
    CaricaAudio(Numero, datiAudio, 'arraybuffer', (ClipAudio) => {
        audioContext.decodeAudioData(ClipAudio).then((buffer) => {
            ...
            if (DatiAudioRegistrato[Numero].numspezzoneCI >= 0) {GeneraBufferCI(DatiAudioRegistrato[Numero], buffer); return;}
            /**********************************************************************************************************************************/
...
function GeneraBufferCI(datiAudio, buffer) {
            ...
            (Contenuto) => {
                audioContext.decodeAudioData(Contenuto).then(
                    (bufferSucc) => {
                        ...
                        datiAudio.taglioFinale = +b.duration + 1;
                        VerificaFunzioneAlTerminePrecaricamento();
...
function CaricaColonnaInternazionale(Dati) {
    ...
    Dati = {Registrazione: "ColonneAudio/263_1661355591_CIspezzone000.ogg,ColonneAudio/263_1661355593_CIspezzone001.ogg,ColonneAudio/263_1661355595_CIspezzone002.ogg,ColonneAudio/263_1661355596_CIspezzone003.ogg,ColonneAudio/263_1661355598_CIspezzone004.ogg,ColonneAudio/263_1661355600_CIspezzone005.ogg,ColonneAudio/263_1661355601_CIspezzone006.ogg,ColonneAudio/263_1661355603_CIspezzone007.ogg,ColonneAudio/263_1661355605_CIspezzone008.ogg,ColonneAudio/263_1661355607_CIspezzone009.ogg,ColonneAudio/263_1661355608_CIspezzone010.ogg,ColonneAudio/263_1661355610_CIspezzone011.ogg,ColonneAudio/263_1661355612_CIspezzone012.ogg,ColonneAudio/263_1661355613_CIspezzone013.ogg,ColonneAudio/263_1661355615_CIspezzone014.ogg,ColonneAudio/263_1661355617_CIspezzone015.ogg,ColonneAudio/263_1661355618_CIspezzone016.ogg", volume: Dati.volume};

    SpezzoniAudioCI = Dati.Registrazione.split(',');

    SpezzoniAudioCI.forEach((SpezzoneAudio, NumSpezzone) => {
        CreaNuovaClipAudio({Registrazione: SpezzoneAudio, N: "CI" + NumSpezzone, ID_Utente: 'ColonnaInternazionale', MinutaggioRegistrazione: 75 * NumSpezzone, TaglioIniziale: 0, TaglioFinale: 75, DurataRegistrazione: 75, Guadagno: Dati.volume}, (datiAudio) => {datiAudio.numspezzoneCI = NumSpezzone;}, false);
    });
