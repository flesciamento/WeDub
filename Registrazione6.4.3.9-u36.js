...
function CreazioneClipPrimoCaricamento(DatiClipAudio) {
    ...
    console.log("NumeroTotaleAudioCaricamentoIniziale", NumeroTotaleAudioCaricamentoIniziale, totClipAudio, (+ModalitaStreaming), (PresenteColonnaInternazionale? +DatiCI.filter(el => el.CI).length : 0));
