...
window.setTimeout(CaricamentoVideo, 2000); tmrCaricamento = window.setInterval(CaricamentoVideo, 10000); window.setTimeout(() => {const imgLogoWEDUB = document.getElementById('imgLogoWEDUB'); imgLogoWEDUB.src = "assets/img/" + LogoPrincipale; imgLogoWEDUB.style.right = ""; imgLogoWEDUB.setAttribute('width', larghezzaLogo)}, secondiCambioLogo);
