...
/*		case "(": NodoAttuale.textContent = NodoAttuale.textContent.slice(0, PosizioneCursore) + ")" + NodoAttuale.textContent.slice(PosizioneCursore); ; return 2;
        ...
        case "V":
        case "v": if (e.ctrlKey) {await pausa(100); console.log("incolla", ElementoAttuale); ElementoAttuale.innerHTML = ElementoAttuale.innerText; const NuovoNodoAttuale = PosizioneDelCursore().nodo; PosizionaCursore(NuovoNodoAttuale, NuovoNodoAttuale.textContent.length - 1); return;}
