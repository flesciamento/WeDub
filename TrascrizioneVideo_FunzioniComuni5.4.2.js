...
CreaElemento('style', 'styleTestoGuida', document.body.id = 'bodyPagina',
    `#ContenitoreTestoGuida {position: fixed; overflow-y: scroll; padding: 5px; background-color: rgba(255, 255, 255, 0.8); border-radius: 10pt; font-size: 1.5vh; line-height: 2vh; text-align: left; text-shadow: 1px 1px 1px aliceblue; border: 1px solid grey; opacity: 0; visibility: hidden; transition: opacity 1s; user-select: none; z-index: 10000000;}
     ...
     #TestoGuida {position: absolute; top: 1.5vh;} #TestoGuida div {cursor: pointer;} #TestoGuida div:hover {background-color: rgba(0, 200, 200, 0.2);}
...
const ManigliaSposta_TestoGuida = CreaElemento('div', 'ManigliaSposta_TestoGuida', 'ContenitoreTestoGuida', "<span class='fa fa-navicon' style='cursor: move;'></span>"); ManigliaSposta_TestoGuida.onmousedown = ManigliaSposta_TestoGuida.ontouchstart = FunzioniCopione.RidimensionaTestoGuida_Attiva; ManigliaSposta_TestoGuida.children[0].onmousedown = ManigliaSposta_TestoGuida.children[0].ontouchstart = FunzioniCopione.SpostaTestoGuida_Attiva;
const LatoSx_TestoGuida = CreaElemento('div', 'LatoSx_TestoGuida', 'ContenitoreTestoGuida'), LatoDx_TestoGuida = CreaElemento('div', 'LatoDx_TestoGuida', 'ContenitoreTestoGuida'), Base_TestoGuida = CreaElemento('div', 'Base_TestoGuida', 'ContenitoreTestoGuida'); LatoSx_TestoGuida.onmousedown = LatoSx_TestoGuida.ontouchstart = FunzioniCopione.RidimensionaTestoGuida_Attiva; LatoDx_TestoGuida.onmousedown = LatoDx_TestoGuida.ontouchstart = FunzioniCopione.RidimensionaTestoGuida_Attiva; Base_TestoGuida.onmousedown = Base_TestoGuida.ontouchstart = FunzioniCopione.RidimensionaTestoGuida_Attiva;
...
var FunzioniCopione = {
    ...
    PosizionaVideo: function (e) {
        ...
        FunzioniCopione.DisattivaCopione(e.currentTarget);
    },
