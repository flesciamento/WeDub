...
function GestisciImmissioneTesto(e) {
	const ElementoAttuale = e.currentTarget, T = ElementoAttuale.parentElement.parentElement, InfoCursore = PosizioneDelCursore(), PosizioneCursore = InfoCursore.p, NodoAttuale = InfoCursore.nodo;
    var nuovatextarea;
