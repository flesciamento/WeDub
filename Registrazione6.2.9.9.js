...
function RiposizionamentoAutomaticoClipSovrapposte(ELTConsiderato) {
    if (ELTDaSpostare == false) {
        ...
        /* Se tra gli ELT sovrapposti ce n'è uno più lungo, rifà l'elaborazione considerando quest'ultimo, aggiungendo gli ELT che si intersecano su di esso */
        ID_ELTLungo = Object.keys(ID_NuoviELTDaRiordinare).sort((a, b) => {return DatiAudioRegistrato[document.getElementById(b).dataset.RiferimentoRegistrazione].Durata - DatiAudioRegistrato[document.getElementById(a).dataset.RiferimentoRegistrazione].Durata;})[0];
        ELTLungo = document.getElementById(ID_ELTLungo);
