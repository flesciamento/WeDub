...
/*		case "[": T.innerHTML = T.innerHTML.slice(0, PosizioneCursore) + VisualizzaMinutaggioAttuale() + "] " + T.innerHTML.slice(PosizioneCursore); T.selectionEnd = PosizioneCursore; setTimeout(() => {T.selectionStart = T.selectionEnd = T.innerHTML.length;}, 100); return 2;
        ...
        case "ArrowUp":   ((NumeroNodoAttuale(InfoCursore.T, NodoAttuale) == 0) && (precedentetextarea = TrovaTextareaVicina(T, -1)) && (precedentetextarea.focus())); break;
        case "ArrowDown": ((NumeroNodoAttuale(InfoCursore.T, NodoAttuale) == (InfoCursore.T.childNodes.length - 1)) && (textareasuccessiva = TrovaTextareaVicina(T, 1)) && (PosizionaCursore(textareasuccessiva.childNodes[0], 0)) && (textareasuccessiva.focus())); break;
		case "Enter":
            ...
            function MandaACapoEAttivaSceltaPersonaggio() {
                ...
                const NumNodoAttuale = NumeroNodoAttuale(T, NodoAttuale);
