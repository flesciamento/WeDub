...
function EliminaEventiPuntatoreDividiClip(ELT) {
    ...
    Righello.removeEventListener('mouseup', DividiClip_puntatorerilasciato);   Righello.ontouchend = "";
}
                ...
                switch(StrumentoMouse) {
                    ...
                    case toolDividiClip:
                        ...
                        if ((datiAudio.taglioIniziale < MinutaggioSelezionatoClip) && (MinutaggioSelezionatoClip < datiAudio.taglioFinale)) {
                            ...
                            Righello.addEventListener('mouseup',   DividiClip_puntatorerilasciato);    Righello.ontouchend = DividiClip_puntatorerilasciato;
