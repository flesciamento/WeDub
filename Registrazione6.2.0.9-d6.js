...
function GestisciTouchMoveLineaTemporale(e) {
    if (e.touches.length == 2) {
        ...
        if (((+GestisciTouchMoveLineaTemporale.PosizioneYPrec - 100) < e.touches[toccobasso].clientY) && (e.touches[toccobasso].clientY < (+GestisciTouchMoveLineaTemporale.PosizioneYPrec + 100))) {return;}
        
        const zoomprecedente = slideZoom.value;
        slideZoom.value += 1 - (2 * (e.touches[toccobasso].clientY < TocchiPrec_Y[toccobasso]));
