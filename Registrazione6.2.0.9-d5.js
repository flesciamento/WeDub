...
function GestisciTouchMoveLineaTemporale(e) {
    if (e.touches.length == 2) {
        ...
        if ((e.touches[toccobasso].clientY | 0) == GestisciTouchMoveLineaTemporale.PosizioneYPrec) {return;}
        ...
        if (zoomprecedente != slideZoom.value) {CambiaZoom();}
        GestisciTouchMoveLineaTemporale.PosizioneYPrec = e.touches[toccobasso].clientY | 0;
    }
}
