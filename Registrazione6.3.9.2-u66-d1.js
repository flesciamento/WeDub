...
function PosizionaElementiScroll() {
    console.log("PosizionaElementiScroll", "inizio", ContenitoreLineaTemporale.offsetTop);
    ...
    console.log("PosizionaElementiScroll", "fine", ContenitoreLineaTemporale.offsetTop);
}
/**********************************************/
...
function AdattaNuovaAltezzaTraccePerc() {
    if (UnitaDiMisura == "%") {const NuovaAltezzaTracciaPerc = "calc(100% - " + ContenitoreLineaTemporale.offsetTop + "px)"; ContenitoreLineaTemporale.style.height = NuovaAltezzaTracciaPerc; document.getElementById('NomiTracce').style.height = NuovaAltezzaTracciaPerc;}
}
    ...
    if (!ModalitaStreaming) {
        ...
        setTimeout(() => {
            ...
            if (RuoliDaAssegnare_NumeroTraccia !== false) {
                ...
                if (!SonoCreatoreProgetto && !SessioneOspite) {AltezzaTracce = window.innerHeight - (Provino? (window.innerHeight * 0.3) : NomiTracce.children[0].offsetHeight) - 200; VariaAltezzaTracce();} // Ingrandisce lo spazio dedicato al video per i doppiatori
            }
            AdattaAltezzaContenitoreTracce();
            console.log("Dopo adatta altezza contenitore tracce", ContenitoreLineaTemporale.offsetTop);
            AutoAdattaElementiInterfaccia();
            console.log("Dopo auto adatta elementi interfaccia", ContenitoreLineaTemporale.offsetTop);
        }, 1000);
...
function AdattaAltezzaTracciaRuoliDaAssegnare() {
    VariaAltezzaTraccia(RuoliDaAssegnare_NumeroTraccia, ((+document.getElementById('divContenutoNomeTraccia' + RuoliDaAssegnare_NumeroTraccia).offsetHeight) + 15));
    SpostaInBassoTracceSuccessive();
}
/******************************************/
