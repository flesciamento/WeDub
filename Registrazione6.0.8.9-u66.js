...
function EliminaEventiPuntatoreDividiClip(ELT) {
    ...
    Righello.removeEventListener('mouseup', DividiClip_puntatorerilasciato);   Righello.removeEventListener('touchend', DividiClip_puntatorerilasciato);
}
                ...
                switch(StrumentoMouse) {
                    ...
                    case toolDividiClip:
                        ...
                        if ((datiAudio.taglioIniziale < MinutaggioSelezionatoClip) && (MinutaggioSelezionatoClip < datiAudio.taglioFinale)) {
                            ...
                            Righello.addEventListener('mouseup',   DividiClip_puntatorerilasciato);    Righello.addEventListener('touchend',  DividiClip_puntatorerilasciato); Righello.addEventListener('touchcancel',  DividiClip_puntatorerilasciato);
...
function AnteprimaSelezioneClip(ELTConsiderato, ClientX) {
    ...
    if (SistemaAttualeAndroid) {divCartello = CreaElemento('div', 'divCartello' + div.id, Righello.id, strCliccaQuiPerConfermareSelezione); divCartello.className = 'alert alert-info'; divCartello.iStyle({position: "fixed", zIndex: 1000000000, bottom: "10px", left: "35%", fontWeight: "bold", fontSize: "16pt", userSelect: "none"});}
