    ...
    const PannelloOpzioni = CreaElemento('div', 'OpzioniDividiClip', document.body.id);
        ...
        const divContenuto = CreaElemento('div', PannelloOpzioni.id + 'Contenuto', PannelloOpzioni.id); divContenuto.className = "panel-body text-center";
            ...
            var divContenitore = CreaElemento('div', 'DividiClip_ContenitoreTagliaViaIlResto', divContenuto.id);
                const pulTagliaViaIlResto = CreaElemento('span', 'DividiClip_pulTagliaViaIlResto', divContenitore.id, "<img style='float: left; height: 40px;' src='images/Esempio_mantenimento_segmento.png' /> " + strTagliaViaIlResto); pulTagliaViaIlResto.className = 'btn btn-default'; pulTagliaViaIlResto.iStyle({width: "100%", fontSize: "14pt", marginBottom: "20px", lineHeight: 1.8});
            ...
            if ((secondiInizioTaglio > taglioclip_diffmin) && (secondiFineTaglio < (DatiAudioRegistrato[ELT.dataset.RiferimentoRegistrazione].Durata - taglioclip_diffmin))) {
                var divContenitore = CreaElemento('div', 'DividiClip_ContenitoreCreaNuovaClip', divContenuto.id);
                    const pulCreaNuovaClip = CreaElemento('span', 'DividiClip_CreaNuovaClip', divContenitore.id, "<img style='float: left; height: 40px;' src='images/Esempio_taglio_nuova_clip.png' /> " + strTagliaECreaNuovaClip); pulCreaNuovaClip.className = 'btn btn-default'; pulCreaNuovaClip.iStyle({width: "100%", fontSize: "14pt", lineHeight: 1.8});
