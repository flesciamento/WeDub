...
function AggiornaRappresentazioneColonnaInternazionale(AggiornaSeModificato = false) {
    ...
    if (AggiornaSeModificato) {
        DisattivaVecchiaCI();
        CaricaColonnaInternazionale({volume: (AudioBufferColonnaInternazionale.length ? GuadagnoPrincipale[AudioBufferColonnaInternazionale[0].numero].gain.value : 1)});
...
function CreazioneClipPrimoCaricamento(DatiClipAudio) {
    ...
    if (!ModalitaStreaming && (PresenteColonnaInternazionale || SonoCreatoreProgetto)) {pulSwitchColonnaInternazionale.abilita(false); SwitchColonnaInternazionale(); setTimeout(() => {pulSwitchColonnaInternazionale.abilita(true);}, 500);}
...
function CaricaColonnaInternazionale(Opzioni) {
    ...
    var EsisteColonnaInternazionale = false;
    for(I = 0; I < totDatiCI; I++) {
        if (DatiCI[I].CI) {
            ...
            EsisteColonnaInternazionale = true;
    ...
    pulSwitchColonnaInternazionale.style.display = (EsisteColonnaInternazionale? "" : "none");
}
