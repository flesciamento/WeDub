...
var ColonnaInternazionale = false, ColonnaInternazionaleAttivata = false;
...
function RiproduciClipInSync(MinutaggioVideo) {
    ...
    ClipDaRiprodurre.forEach((I) => {
        ...
        const g = GuadagnoPrincipale[I].gain.value; GuadagnoPrincipale[I].gain.value = 0; GuadagnoPrincipale[I].gain.linearRampToValueAtTime(g, audioContext.currentTime + SecondiPartenzaAudio + 1);
...
function CreaNuovaClipAudio(Dati, FunzioneAlTermine) {
    GeneraDatiAudio(Dati, ++CreaNuovaClipAudio.N, (ModalitaStreaming? "" : VisualizzazioneNellaLineaTemporale), FunzioneAlTermine);
}
