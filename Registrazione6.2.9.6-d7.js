...
function RiposizionamentoAutomaticoClipSovrapposte(ELTConsiderato) {
    if (ELTDaSpostare == false) {
        ...
        var ID_NuoviELTDaRiordinare = [], ID_ELT_trovati = [];
        ...
        TrovaELTDaRiordinare(ELTConsiderato);
        ...
        ID_ELT_trovati.sort((a, b) => {return DatiAudioRegistrato[document.getElementById(b).dataset.RiferimentoRegistrazione].Durata - DatiAudioRegistrato[document.getElementById(a).dataset.RiferimentoRegistrazione].Durata;});
        ELTLungo = document.getElementById(ID_ELT_trovati[0]);
        if (ELTLungo != ELTConsiderato) {console.log("Rimanda", NuoviELTDaRiordinare[0], ELTConsiderato); TrovaELTDaRiordinare(ELTLungo);}
        ...
        /* Ordina gli ELT sovrapposti da quello più a sinistra a quello più a destra */
        ID_ELT_trovati = Object.keys(ID_NuoviELTDaRiordinare);
        ID_ELT_trovati.sort((a, b) => {
            const da1 = DatiAudioRegistrato[document.getElementById(a).dataset.RiferimentoRegistrazione], da2 = DatiAudioRegistrato[document.getElementById(b).dataset.RiferimentoRegistrazione];
            return ((+da1.MinutaggioRegistrazione) + (+da1.taglioIniziale)) - ((+da2.MinutaggioRegistrazione + (+da2.taglioFinale)));
        });
        
        /* Effettua il riposizionamento */
        const totELTDaRiordinare = ID_ELT_trovati.length;
        console.log(totELTDaRiordinare, ID_NuoviELTDaRiordinare);
