...
/*		case "(": NodoAttuale.textContent = NodoAttuale.textContent.slice(0, PosizioneCursore) + ")" + NodoAttuale.textContent.slice(PosizioneCursore); ; return 2;
        ...
        case "V":
        case "v": if (e.ctrlKey) {await pausa(200); PosizionaCursore(ElementoAttuale.childNodes[0], ElementoAttuale.textContent.length);}
...
function RiprendiVideoAutomaticamente(Textarea) {
    ...
    SalvaCopione.salvataggioinsospeso[NumID] = true;
    VideoGuidaPause();
