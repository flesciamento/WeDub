...
function ApriFinestraCI_e_monitora(e) {
    ...
    ApriFinestraCI_e_monitora.tmr = setInterval(() => {AJAX("AttivitaFinestraCI.php", "", (Dati) => {if (((new Date().getTime() / 1000) - Dati.DataUltimoRilevamentoFinestraCI) > 6) {AcquisisciNuovaCI(); clearInterval(ApriFinestraCI_e_monitora.tmr);}}, "", "", true);}, 3000);
}
