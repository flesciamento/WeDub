...
function VariaAltezzaTracce() {
    const NuovaPosizione = (AltezzaTracce / window.innerHeight * 100) + "%";
...
function AttivaProgramma() {
    ...
    if (!ModalitaStreaming) {
        ...
        setTimeout(() => {
            ...
            if (!SonoCreatoreProgetto && !SessioneOspite) {AltezzaTracce = window.innerHeight - (Provino? (window.innerHeight * 0.4) : NomiTracce.children[0].offsetHeight) - 100; VariaAltezzaTracce();} // Ingrandisce lo spazio dedicato al video per i doppiatori
