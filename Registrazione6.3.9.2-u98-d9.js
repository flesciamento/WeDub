...
function handleSuccess(stream) {
    ...
    console.log("Qualita alta registrazione", QualitaAltaRegistrazione);
...
function VideoGuidaPronto() {
    ...
    CreaMenuADiscesa([
        {DoveInserirlo: 'OpzioniRegistrazione', ID_Contenitore: 'SelezioneCanaleRegistrazione',  ID_Menu: 'CanaleRegistrazione',  stiliContenitore: {float: "left"}, stiliMenu: {fontSize: "10px"}, Elementi: [{dato: 0, stringa: strCanaleSx, predefinito: true}, {dato: 1, stringa: strCanaleDx}], FunzioneAlClick: AttivaIngressi},
        {DoveInserirlo: 'OpzioniRegistrazione', ID_Contenitore: 'SelezioneQualitaRegistrazione', ID_Menu: 'QualitaRegistrazione', stiliContenitore: {float: "left"}, stiliMenu: {fontSize: "10px"}, Elementi: [{dato: 1, stringa: strQualitaAlta, predefinito: !CondizioneQualitaMedia}, {dato: 0, stringa: strQualitaMedia, predefinito: CondizioneQualitaMedia}], FunzioneAlClick: AttivaIngressi, SpiegazioneFunzioni: SpiegazioneQualitaRegistrazione}
    ]);
