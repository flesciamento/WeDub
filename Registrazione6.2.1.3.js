...
async function TermineCaricamentoClip() {
    if (!CaricamentoInizialeTerminato) {
        ...
        Messaggio(strCaricamentoCompletato + (!ModalitaStreaming ? (SessioneOspite? "<br /><span style='font-size: 12px'; font-style: italic;'>" +  (Provino || ProgettoCompletato) ? + strModalitaVisualizzazione + "</span><br />" : strNonHaiNessunRuolo + "<br />" + (!SonoCreatoreProgetto ? strPuoiSoloVisualizzare : "") + "</span><br />" : "") + (SonoCreatoreProgetto? "<span style='font-size: 13px; font-weight: bold; font-style: italic;'>" + strPoteriCreatoreProgetto + "</span>" : "") : ""), "OK");
        await pausa(1000);
        if (ModalitaStreaming) {
