...
const ContenitoreCopione.FunzioniCopione = {
    AggiornaTestoGuida: function() {
        ContenitoreCopione.FunzioniCopione.InviaComando({tipo: 'aggiorna'});
    },

    AttivaTestoGuida: function() {
        ContenitoreCopione.FunzioniCopione.AggiornaMinutaggioCopioneInAltraFinestra();
        ContenitoreCopione.FunzioniCopione.InviaComando({tipo: 'attivatesto'});
    },

    DisattivaTestoGuida: function() {
        ContenitoreCopione.FunzioniCopione.InviaComando({tipo: 'disattivatesto'});
    },

    DisattivaCopione: function() {
        ContenitoreCopione.FunzioniCopione.InviaComando({tipo: 'disattiva'});
    },

    RiattivaCopione: function() {
        ContenitoreCopione.FunzioniCopione.InviaComando({tipo: 'riattiva'});
    },

    OpacitaCopioneDisattivato: function(opacita) {
        ContenitoreCopione.FunzioniCopione.InviaComando({tipo: 'opacitasedisattivato', valore: opacita});
    },

    InviaComando: function(Comando) {

            InviaPostMessage(ContenitoreCopione.FunzioniCopione.Contenitore, Comando);
        } else {
            switch(Comando.tipo) {
