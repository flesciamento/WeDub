...
function SelezionaESpostaELT(NumeroAudio, X = 0) {
    if ((OpzClip = document.getElementById(ID_Opzioni)) && (OpzClip.dataset.nonmodificareselezionemultipla)) {console.log("OpzioniClip nonmodificareselezionemultipla", OpzClip.dataset.nonmodificareselezionemultipla); return;}
                                        ...
                                        for(A = 2; A < NumeroAttacchi; A += 2) {
                                            ...
                                            if ((SecondiStacco - SecondiAttacco) > SpezzaBattute.SecondiTaglioMinimo) {
                                                DuplicaClip(Numero, (ClipNuova) => {
                                                    ...
                                                    if (NuoveClipCreate.length >= (NumeroAttacchi / 2) - 1) {SuddivisioneInBattuteEffettuata();}
                                                });
                                            } else {
                                                SuddivisioneInBattuteEffettuata();
                                            }
                                        }
                                    } else {
