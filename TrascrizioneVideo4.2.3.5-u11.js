...
function SalvaCopione(Textarea) {
	...
	AJAX("TrascrizioneVideo_SalvaCopione-unstable.php", "NumID=" + encodeURIComponent(Textarea.dataset.numid) + "&N=" + encodeURIComponent(N) + "&Testo=" + encodeURIComponent(Textarea.innerHTML) + "&Minutaggio=" + encodeURIComponent(Textarea.dataset.minutaggio), "", "", strModificheSalvate, true);
}
