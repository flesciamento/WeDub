...
function EliminaBloccoTestoVuoto(e) {
    ...
    if (['Delete', 'Backspace'].includes(e.key) && (T.value == "")) {
...
function TrovaTextareaVicina(T, PosRelativa) {
    while (Rigo = (document.getElementById('RigoBloccoTesto' + ((+T.dataset.rifRigo) + (+PosRelativa))) || ({style: {display: ''}})).style.display == 'none') {PosRelativa++;}
