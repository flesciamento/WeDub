...
function VisualizzaModificaAudioAscoltato(datiAudio) {
    document.getElementById('ELTReg' + datiAudio.numero).children[0].style.borderColor = ColoreBordoClipAscoltata;
    datiAudio.alPlay = [];
...
function CreaFinestraOpzioniClip(RiferimentoRegistrazione) {
    ...
    const divcontenitorebody = CreaElemento('div', ID_Opzioni + 'ContenitoreOpzioniBody', ID_Opzioni); divcontenitorebody.className = "panel-body";
        ...
        /******************************/
                                        ...
                                        /* Minutaggio */
        const tabellaminutaggio = CreaElemento('table', ID_Opzioni + 'TabellaMinutaggio', divcontenitorebody.id); tabellaminutaggio.iStyle({float: "left", width: "250px", textAlign: "center"});
                    ...
                    const divTrattamentoAudio = CreaElemento('div', ID_Opzioni + 'divTrattamentoAudio', divOpzioniVarie.id); divTrattamentoAudio.className = "btn"; divTrattamentoAudio.iStyle({cursor: "auto", width: "fit-content"});
                        const fieldsetTrattamentoAudio = CreaElemento('fieldset', divTrattamentoAudio.id + "fieldset", divTrattamentoAudio.id);
                            ...
                            pulSpezzaBattute.onclick = async (e) => {
                                ...
                                if (NumeroAttacchi > 1) {
                                    const slideTaglioIniziale = document.getElementById(ID_Opzioni + 'TabellaOpzioniRigaTaglioInizialeCasella'); slideTaglioIniziale.value = attacchi[0]; slideTaglioIniziale.dispatchEvent(ev_cambiamento);
                                    const slideTaglioFinale = document.getElementById(ID_Opzioni + 'TabellaOpzioniRigaTaglioFinaleCasella'); slideTaglioFinale.value = attacchi[1]; slideTaglioFinale.dispatchEvent(ev_cambiamento);
