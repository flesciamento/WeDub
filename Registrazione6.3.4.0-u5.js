...
function CreaRegistrazione_wav() {
    ...
    taglioiniziale = leftBuffer.indexOf(leftBuffer.find((a) => {return a > AutoTaglioIniziale.SogliaDB;})) - (AutoTaglioIniziale.Tolleranza * sampleRate);
    taglioiniziale *= (taglioiniziale > 0);
    MinutaggioUltimaRegistrazione += (taglioiniziale / sampleRate);
    leftBuffer = leftBuffer.slice(taglioiniziale);
