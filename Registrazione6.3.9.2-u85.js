...
function DisabilitaElementiGenerali(Disabilita) {
    ...
    divSelettoreMicrofono.abilita(!Disabilita); pulMonitorMic.abilita(!Disabilita); opzCanaleRegistrazione.disabled = Disabilita; selectQualitaRegistrazione.disabled = Disabilita;
