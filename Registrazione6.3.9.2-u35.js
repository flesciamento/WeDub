...
function SelezionaCandidatoRuoliDaAssegnare(ID) {
    ...
    AJAX("DatiUtente.php", "ID=" + encodeURIComponent(ID),
        function (Dati) {
            ...
            setTimeout(() => {VariaAltezzaTraccia(RuoliDaAssegnare_NumeroTraccia, (+document.getElementById('divContenutoNomeTraccia' + RuoliDaAssegnare_NumeroTraccia).offsetHeight) + 100 + (55 * SonoCreatoreProgetto)); SpostaInBassoTracceSuccessive();}, 100);
