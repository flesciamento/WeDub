...
function VariaAltezzaTracce() {
    ...
    if (UnitaDiMisura == "%") {ContenitoreLineaTemporale.style.height = "calc(80% - " + NuovaPosizioneContenitore; document.getElementById('NomiTracce').style.height = "calc(100% - " + NuovaPosizioneContenitore;}
