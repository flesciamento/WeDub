...
function SpostaTestoGuida(e) {
    ...
    ContenitoreTestoGuida.iStyle({top: Y + "px", left: (+X - ContenitoreTestoGuida.dataset.posizionedelmouse) + "px", right: ((ContenitoreTestoGuida.dataset.leftiniziale - (+X - ContenitoreTestoGuida.dataset.posizionedelmouse)) - ContenitoreTestoGuida.dataset.rightiniziale) + "px", bottom: ((ContenitoreTestoGuida.dataset.topiniziale - Y) - ContenitoreTestoGuida.dataset.bottominiziale) + "px"});
}
