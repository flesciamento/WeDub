...
CreaElemento('style', 'styleTestoGuida', document.body.id,
    `.TestoGuida-evidenziato {background-color: rgba(200, 255, 200); border-radius: 10px;}
     ...
     #LatoSx_TestoGuida {position: absolute; top: 0px; left: 0px; width: 1vh; cursor: col-resize;}
...
const LatoSx = CreaElemento('div', 'LatoSx_TestoGuida', 'ContenitoreTestoGuida'); LatoSx.onmousedown = RidimensionaTestoGuida_Attiva;
...
function SpostaTestoGuida_Attiva(e) {
    ...
    ContenitoreTestoGuida.iStyle({cursor: "grab", transition: ''});
...
function SpostaTestoGuida_Disattiva() {
    ContenitoreTestoGuida.iStyle({cursor: '', transition: '500ms'});
...
function RidimensionaTestoGuida_Attiva(e) {
    const DaModificare = {'LatoSx_TestoGuida': {style: 'left', CoordinatePuntatore: 'clientX'}, 'LatoDx_TestoGuida': {style: 'right', CoordinatePuntatore: 'clientX'}, 'Tetto_TestoGuida': {style: 'top', CoordinatePuntatore: 'clientY'}, 'Base_TestoGuida': {style: 'bottom', CoordinatePuntatore: 'clientY'}};
...
function RidimensionaTestoGuida(e) {
    ...
    ContenitoreTestoGuida.iStyle({[ContenitoreTestoGuida.dataset.styledamodificare]: Coordinata + "px"})
}
