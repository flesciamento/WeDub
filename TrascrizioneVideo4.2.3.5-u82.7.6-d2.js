...
function AggiornaMinutaggio(e) {
    ...
    var MinutaggioNuovo = ((min.textContent * 60) + (+sec.textContent)); console.log(MinutaggioNuovo);
    ...
    console.log(textareaprecedente, textareasuccessiva, LimiteMinimo, LimiteMassimo, MinutaggioNuovo, MN);
