                    ...
                    td = CreaElemento('td', ID_Opzioni + 'tdOpzioneRiduciRumore', tr.id);
                        ...
                        pulRiduciRumore.onclick = async (e) => {
                            ...
                            function VerificaTermineProcesso() {
                                AJAX("CaricaBlobTemp.php", "N=" + encodeURIComponent(da.NumeroUnivoco), (Dati) => {if (Dati.urlBlob) {console.log(Dati.urlBlob); pulsante.abilita(true);} else {setTimeout(VerificaTermineProcesso, 1000);}});
                            }
