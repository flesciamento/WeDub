...
function MinutaggioCambiato() {
    ...
    console.log(MinutaggioNuovo, MinutaggioNuovoAggiustato);
...
function Posizionati(MinutaggioNuovo, RiabilitaTuttaLaSchermata = false) {
    ...
    setTimeout(() => {PosizionaCursore(MinutaggioNuovo); AggiornaMinutaggioVideo(MinutaggioNuovo); console.log("Aggiornato minutaggio");}, 100);
    StopVideoGuida();
    ImmagineAttesaVideoGuida(true);
    VideoGuidaPosizionati(MinutaggioNuovo); console.log("Spostato video guida al minutaggio", MinutaggioNuovo);
