    ...
    div = CreaElemento('div', ID_Opzioni + 'ContenitoreOpzioniBody', ID_Opzioni); div.className = "panel-body";
        ...
        /***********************************************************************/
               ...
               CreaSlide('TaglioFinale',      strTaglioFinale,   taglioclip_diffmin, LunghezzaRegistrazione, 0.01, taglioclip_diffmin, LunghezzaRegistrazione, 0.01, strsecondi, ev_CambiaTaglioFinaleClip,    ev_CambiaTaglioFinaleClip,   datiAudio.taglioFinale,   FunzioneOnChangePerTagliInizialiEFinali);
                                                    ...
                                                    /* Varie */
                divOpzioniVarie = CreaElemento('div', ID_Opzioni + 'divOpzioniRigaVarie', Tabella.id);
                                ...
                                if (NumeroAttacchi > 1) {
                                    ...
                                    if (NumeroAttacchi > 2) {
                                        for(A = 2; A < NumeroAttacchi; A += 2) {
                                            ...
                                            DuplicaClip(Numero, (ClipNuova) => {ClipNuova.taglioIniziale = SecondiAttacco; ClipNuova.taglioFinale = SecondiStacco; SelezionaESpostaELT(ClipNuova.numero); VisualizzazioneGraficaTaglioClip(ClipNuova.numero); NuoveClipCreate.push(ClipNuova); if (NuoveClipCreate.length >= (NumeroAttacchi / 2) - 1) {Riattiva(); document.getElementById(ID_Opzioni).dataset.nonmodificareselezionemultipla = "1";}});
                                        }
                                    } else {
                                        Riattiva();
                                    }
