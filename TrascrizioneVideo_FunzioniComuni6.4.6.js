...
var FunzioniCopione = {
    ...
    EvidenziaPersonaggio: function (e) {
        ...
        if (!document.querySelector(`.${FunzioniCopione.ClasseEvidenziaBattuta} [name="Battuta_${PersonaggioDaEvidenziare}"]`) && !RiproduzioneInCorso) {FunzioniCopione.PosizionatiBattutaPersonaggio();}
    },
    /***************************/
