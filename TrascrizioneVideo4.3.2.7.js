	...
	AJAX("TrascrizioneVideo_CaricaCopione.php", "N=" + encodeURIComponent(N),
        async function (Dati) {
                ...
                if (totBlocchiDiTesto == 0) {
                    ...
                    FormSottotitoli(divContenitoreID, true);
...
function FormSottotitoli(DoveInserirlo, CaricamentoAutomatico = true) {
    ...
    if (CaricamentoAutomatico) {inputFileSottotitoli.onchange = () => {document.getElementById('frmFileSottotitoli').submit();};} else {CreaElemento('div', 'pulProcediCaricamentoSottotitoli', 'PannelloOpzioni', strPulCaricaISottotitoli).onclick = () => {if (confirm(strConfermaCaricaSottotitoliInSostituzione)) {document.getElementById('frmFileSottotitoli').submit();}}}
