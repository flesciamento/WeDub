...
function RiproduciClipInSync(MinutaggioVideo) {
    ...
    console.log("Richiamato RiproduciClipInSinc", ClipDaRiprodurre);
    ...
    ClipDaRiprodurre.forEach((I) => {
        ...
        console.log("clip", I, SecondiPartenzaAudio, InizioClip, FineClip);
    ...
    console.log("Terminato RiproduciClipInSync");
    ClipDaRiprodurre = [];
...
function PlayVideoGuida() {
    ...
    console.log("Richiamato PlayVideoGuida");
    ...
    if (RiproduzioneInCorso == false) {
        ...
        if (StoRegistrando == false) {
            ...
            console.log("PlayVideoGuida - Superato VerificaClipPrecaricate");
            ElaboraClipDaRiprodurre();
            if (ModalitaStreaming) {
            ...
            RiabilitaSchermata();
            VideoGuidaPlay();
            console.log("PlayVideoGuida - Superato VideoGuidaPlay");
...
function ElaboraClipDaRiprodurre() {
    ...
    console.log("ElaboraClipDaRiprodurre", totAudio, MinutaggioVideo);
...
function VerificaClipDaRiprodurre(I, MinutaggioVideo) {
    const datiAudio = DatiAudioRegistrato[I]; console.log("VerificaClipDaRiprodurre", I);
    ...
    console.log("VerificaClipDaRiprodurre", ClipDaRiprodurre);
}
