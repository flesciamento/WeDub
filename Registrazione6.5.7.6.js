...
function AutoAdattaElementiInterfaccia() {
    ...
    const AltezzaPannelloSx = ContenitorePannelloSx.offsetHeight, AltezzaPannelloDx = ContenitorePannelloDx.offsetHeight, OverflowPannelloSx = (AltezzaPannelloSx > Monitors.offsetHeight), OverflowPannelloDx = (AltezzaPannelloDx > Monitors.offsetHeight);
