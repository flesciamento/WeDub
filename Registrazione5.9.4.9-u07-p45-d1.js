...
function CreazioneClipPrimoCaricamento(Dati) {
    ...
    NumeroTotaleAudioCaricamentoIniziale = totClipAudio + (+ModalitaStreaming) + (+PresenteColonnaInternazionale);
    console.log(NumeroTotaleAudioCaricamentoIniziale);
    ...
    if (ModalitaStreaming) {
        log_numdaprecaricare = 0;
        for (I = 0; I < totClipAudio; I++) {
            NumeroTotaleAudioCaricamentoIniziale += ClipDaPrecaricare(I, 0, SecondiPrecaricamentoAlPlay);
            log_numdaprecaricare++
        }
        console.log(log_numdaprecaricare, NumeroTotaleAudioCaricamentoIniziale);
...
function AggiornaCaricamentoClip(VisualizzaBarraCaricamento = false) {
    totClipAudioCaricate++; console.log(totClipAudioCaricate, NumeroTotaleAudioCaricamentoIniziale);
