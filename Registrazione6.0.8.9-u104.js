...
function VisualizzaOndaSonoraClipCompleta(ELT, Visualizza) {
...
function AnteprimaSelezioneClip(ELTConsiderato, ClientX, FunzioneTouchEnd = () => {}) {
    ...
    AnteprimaSelezioneClip.Elimina = () => {EliminaElemento(div); VisualizzaOndaSonoraClipCompleta(ELT, VisualizzaOndaSonoraClipCompleta.MantieniAttivo = false); ELT.style.zIndex = ""; clearTimeout(AnteprimaSelezioneClip.tmr);};
}
