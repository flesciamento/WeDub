...
function SpostaTestoGuida_Attiva(e) {
    ...
    ContenitoreTestoGuida.dataset.topiniziale = ContenitoreTestoGuida.offsetTop;
    ContenitoreTestoGuida.dataset.bottominiziale = window.innerHeight - ContenitoreTestoGuida.offsetHeight;
    ContenitoreTestoGuida.dataset.leftiniziale = ContenitoreTestoGuida.offsetLeft;
    ContenitoreTestoGuida.dataset.rightiniziale = window.innerWidth - ContenitoreTestoGuida.offsetRight;
...
function SpostaTestoGuida(e) {
    ...
    ContenitoreTestoGuida.iStyle({top: Y + "px", left: (+X - ContenitoreTestoGuida.dataset.posizionedelmouse) + "px", right: (ContenitoreTestoGuida.dataset.rightiniziale - (ContenitoreTestoGuida.dataset.leftiniziale - ContenitoreTestoGuida.offsetLeft)) + "px", bottom: (ContenitoreTestoGuida.dataset.bottominiziale - (ContenitoreTestoGuida.dataset.topiniziale - ContenitoreTestoGuida.offsetTop)) + "px"});
}
