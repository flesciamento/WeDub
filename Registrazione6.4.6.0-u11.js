...
function SwitchColonnaInternazionale(CI) {
    ...
    if (pulEscludiTracciaCI = document.getElementById('EscludiRipristinaTraccia' + (NumeroTotaleTracce - 1))) {pulEscludiTracciaCI.onclick = pulSwitchColonnaInternazionale.onclick;}
