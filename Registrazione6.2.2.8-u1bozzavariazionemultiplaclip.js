...
function DisabilitaElementiGenerali(Disabilita) {
    ...
    SelezioneMicrofono.disabled = Disabilita; selectQualitaRegistrazione.disabled = Disabilita; pulMonitorMic.abilita(!Disabilita);
        ...
        switch(StrumentoMouse) {
            case toolStandard:
                if (!ELTDaSpostare) {
                    ...
                    if (ELTCliccato != ELTDaSpostare) {
                        EliminaElemento(document.getElementById(ID_Opzioni + 'tdOpzionePosizioneMinutiSecondi'));
                        EliminaElemento(document.getElementById(ID_Opzioni + 'TabellaOpzioniRiga' + TaglioIniziale));
                        EliminaElemento(document.getElementById(ID_Opzioni + 'TabellaOpzioniRiga' + TaglioFinale));
                        EliminaElemento(document.getElementById(ID_Opzioni + 'TabellaOpzioniRigaVarie'));
                        EliminaElemento(document.getElementById(ID_Opzioni + 'textareaCommenti'));
...
function VideoGuidaPronto() {
    ...
    if (!ModalitaStreaming) {
        ...
        AltreFunzioniVisualizzaCopioneWeDub = () => {
            ...
            if (DatiDoppiatori[ID_Utente]) {OpzEvidenzia_TestoGuida.value = DatiDoppiatori[ID_Utente].ruolo; OpzEvidenzia_TestoGuida.dispatchEvent(new Event('change'));}
        };
