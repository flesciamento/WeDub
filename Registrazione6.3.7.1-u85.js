...
function StoppaAutomaticamenteAscoltoInSolo(datiAudio) {
    if (document.getElementById(ID_Opzioni + 'PulAscolta').className.indexOf('warning') > -1) {datiAudio.audio.onended = ""; StoppaClipAudio(); ResettaPulAscolta();} // L'eliminazione della funzione "onended" serve per evitare che si intercetti l'evento allo stop della registrazione
}
/********************************/
