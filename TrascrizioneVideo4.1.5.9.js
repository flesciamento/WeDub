const SP = document.getElementById('SceltaPersonaggi'), inputSceltaPersonaggio = document.getElementById('inputNomePersonaggio'), inputSecondiRiprendiVideo = document.getElementById('inputSecondiRiprendiVideo'), divVetro = document.getElementById('Vetro');
	...
	AJAX("TrascrizioneVideo_CaricaCopione.php", "N=" + encodeURIComponent(N),
        function (Dati) {
                ...
                if (totBlocchiDiTesto == 0) {
                    document.getElementById('ContenitoreTesto').insertAdjacentHTML('beforeend', `<tr style='width: 100%;'><td id='tdContenitoreTesto' style='width: 100%; text-align: center;'></td></tr>`);
                    const pulAvvia = CreaElemento('a', 'pulAvvia', 'tdContenitoreTesto', strPulAvvia); pulAvvia.className = "btn btn-default";
                    pulAvvia.onclick = (e) => {
