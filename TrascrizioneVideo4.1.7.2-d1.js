...
function MettiFocusTextareaCorrispondente() {
    setTimeout(() => {
        ...
        for (let I = 0; I < totTextarea; I++) {
            ...
            if ((T.dataset.minutaggio <= MinutaggioCorrente) && (MinutaggioCorrente < textareasuccessiva.dataset.minutaggio) && (document.activeElement != T)) {console.log("focus", T); T.focus(); T.selectionStart = T.selectionEnd = T.value.length; break;}
        }
