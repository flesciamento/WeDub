...
function SelezionaCandidatoRuoliDaAssegnare(ID) {
    ...
    AJAX("DatiUtente.php", "ID=" + encodeURIComponent(ID),
        function (Dati) {
            ...
            VariaAltezzaTraccia(RuoliDaAssegnare_NumeroTraccia, (+document.getElementById('divContenutoNomeTraccia' + RuoliDaAssegnare_NumeroTraccia).offsetHeight) + 25 + (65 * SonoCreatoreProgetto)); SpostaInBassoTracceSuccessive();
