...
function CreazioneClipPrimoCaricamento(Dati) {
    ...
    if (ModalitaStreaming) {
        ...
        PrecaricaClip(InizioVideoGuida, (+InizioVideoGuida) + (+SecondiPrecaricamentoAlPlay), () => {AggiornaCaricamentoClip(true);}, {FunzioneAlTermineSingoloPrecaricamento: () => {AggiornaCaricamentoClip(true);}, SoloBuffer: true});
