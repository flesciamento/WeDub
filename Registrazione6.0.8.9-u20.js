...
function DisabilitaELT_tranne(Numero, Disabilita) {
    const totAudio = DatiAudioRegistrato.length, StylePointerEvents = (Disabilita? "none" : "auto");
    for (let I = 0; I < totAudio; ((++I == Numero) ? I++ : "")) {
        document.getElementById('ELTReg' + I).style.pointerEvents = StylePointerEvents;
    }
}
