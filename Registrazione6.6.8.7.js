...
function CambiaTool(Tool) {
    if ((Righello.dataset.DisattivaClick == "si") || (pulPlay.disabled)) {return false;}
...
function GestioneEventoELTCliccato(e) {
    ...
    if ((!StoRegistrando) && ( ((Righello.dataset.DisattivaClick == "no") && (!pulPlay.disabled)) || ((StrumentoMouse == toolStandard) && ELTDaSpostare)) ) { // Attiva la finestra delle opzioni, il trascinamento col mouse o la selezione multipla se il righello è attivo oppure se era stata selezionata almeno una clip
