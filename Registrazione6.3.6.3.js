...
function DividiClip_puntatorerilasciato(e) {
    ...
    const PannelloOpzioni = CreaElemento('div', 'OpzioniDividiClip', document.body.id);
        ...
        const divContenuto = CreaElemento('div', PannelloOpzioni.id + 'Contenuto', PannelloOpzioni.id); divContenuto.className = "panel-body text-center";
            const pulTagliaViaSelezionato = CreaElemento('div', 'DividiClip_pulTagliaViaSelezionato', divContenuto.id, "<img style='float: left; height: 40px;' src='images/Esempio_taglio_segmento.png' />" + strTagliaViaSelezionato); pulTagliaViaSelezionato.className = 'btn btn-default btn-lg'; pulTagliaViaSelezionato.iStyle({width: "100%", fontSize: "14pt", margin: "20px 0", lineHeight: 1.8});
            ...
            const pulTagliaViaIlResto = CreaElemento('div', 'DividiClip_pulTagliaViaIlResto', divContenuto.id, "<img style='float: left; height: 40px;' src='images/Esempio_mantenimento_segmento.png' />" + strTagliaViaIlResto); pulTagliaViaIlResto.className = 'btn btn-default'; pulTagliaViaIlResto.iStyle({width: "100%", fontSize: "14pt", lineHeight: 1.8});
            ...
            if ((secondiInizioTaglio > taglioclip_diffmin) && (secondiFineTaglio < (DatiAudioRegistrato[ELT.dataset.RiferimentoRegistrazione].Durata - taglioclip_diffmin))) {
                const pulCreaNuovaClip = CreaElemento('div', 'DividiClip_CreaNuovaClip', divContenuto.id, "<img style='float: left; height: 40px;' src='images/Esempio_mantenimento_segmento.png' />" + strTagliaECreaNuovaClip); pulCreaNuovaClip.className = 'btn btn-default'; pulCreaNuovaClip.iStyle({width: "100%", fontSize: "14pt", lineHeight: 1.8});
                      pulCreaNuovaClip.onclick = (e) => {
                            const Numero = ELT.dataset.RiferimentoRegistrazione;
                            VisualizzaAttenderePrego(e.currentTarget);
                            DividiClip(Numero, secondiInizioTaglio, secondiInizioTaglio, "", () => {DividiClip(Numero, secondiFineTaglio, secondiFineTaglio)});
                      };
                }
