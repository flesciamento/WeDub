...
/* 		case "Control": if (e.location == 2) {RiprendiDaPocoPrima(6);} */
        ...
        case "ArrowUp":   ((PosizioneCursore < 20) && (precedentetextarea = TrovaTextareaVicina(-1)) && (precedentetextarea.focus())); break;
        case "ArrowDown": ((PosizioneCursore > (T.value.length - 5))) && (textareasuccessiva = TrovaTextareaVicina(1)) && (textareasuccessiva.focus()); break;
		case "Enter":
            ...
            if (textareasuccessiva = TrovaTextareaVicina(1)) {
    ...
    const tr = CreaElemento('tr', 'tr' + NumRigo, "ContenitoreTesto");
            td = CreaElemento('td', 'tdInfoMinutaggio' + NumRigo, tr.id); td.iStyle({width: "100px", backgroundColor: "white", textAlign: "center", verticalAlign: "top", fontSize: "10px"});
                    ...
                    S.addEventListener('change', (e) => {
                        ...
                        const textareaprecedente = TrovaTextareaVicina(-1) || ({dataset: {minutaggio: -2}}), textareasuccessiva = TrovaTextareaVicina(1) || ({dataset: {minutaggio: totDurataVideoGuida}});
                        ...
                        MinutaggioNuovo *= LimiteMinimoRispettato * LimiteMassimoRispettato + (LimiteMinimo * !LimiteMinimoRispettato) + (LimiteMassimo * !LimiteMassimoRispettato);
