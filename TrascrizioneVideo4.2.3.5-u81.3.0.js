        ...
        case "Backspace":
            if (T.innerText.trim() == "") {
                ...
                if ((e.key == "Backspace") && (PosizioneCursore < 2)) {
                    ...
                    SalvaCopione(T, true, NumeroChildren(T, spanBattuta) - (1 * EraPresentePersonaggio), (EraPresentePersonaggio? spanBattuta.previousElementSibling.previousElementSibling.children.length - 1 : NumeroChildren(spanBattuta, ElementoAttuale) - 3));
                    return;
                }
            }
            break;
