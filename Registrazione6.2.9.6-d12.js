...
function RiposizionamentoAutomaticoClipSovrapposte(ELTConsiderato) {
    if (ELTDaSpostare == false) {
        ...
        /* Memorizza gli ID di tutti gli ELT trovati, in ordine alfabetico */
        ID_ELT_trovati = Object.keys(ID_NuoviELTDaRiordinare).sort((a, b) => {return a > b;});
        
        /* Effettua il riposizionamento */
        const totELTDaRiordinare = ID_ELT_trovati.length;
        console.log(totELTDaRiordinare, ID_NuoviELTDaRiordinare, ID_ELT_trovati);
