...
CreaElemento('style', 'styleTestoGuida', document.body.id,
    `.TestoGuida-evidenziato {background-color: rgba(200, 255, 200); border-radius: 10px;}
     #ManigliaSposta_TestoGuida {position: sticky; top: 0px; width: 100%; font-size: 1.5vh; text-align: center; background-color: rgba(255, 255, 255, 0.6); z-index: 1;}
     ...
     #Tetto_TestoGuida  {position: absolute; top: 0px;    left: 0px; height: 3vh; width: 100%; cursor: row-resize; z-index: 1;}
     #Base_TestoGuida   {position: absolute; bottom: 0px; left: 0px; height: 3vh; width: 100%; cursor: row-resize; z-index: 1;}
