                ...
                tr = CreaElemento('tr', ID_Opzioni + 'TabellaOpzioniRigaVarie', Tabella.id);
                    ...
                    td = CreaElemento('td', ID_Opzioni + 'tdOpzioneRiduciRumore', tr.id);
                        ...
                        pulRiduciRumore.onclick = async (e) => {
                            ...
                            ApriFinestra({currentTarget: {dataset: {larghezza: "800px", altezza: "600px", link: "prova_ffmpeg_nuovo.php?N=" + encodeURIComponent(N) + "&Percorso=" + encodeURIComponent(bloburl)}}});
...
window.addEventListener("message", (e) => {
  ...
  if ((e.origin !== window.location.origin) || (StoRegistrando) || (Righello.dataset.DisattivaClick == "si")) {return;}
    ...
    switch(Dati.tipo) {
        ...
        case 'risultato_ffmpeg': console.log(Dati); break;
    }
