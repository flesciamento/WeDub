...
function GestioneEventoELTCliccato(e) {
    ...
    if ((Righello.dataset.DisattivaClick == "no") || (StrumentoMouse == toolStandard)) { // Attiva il trascinamento col mouse se il righello è attivo oppure in ogni caso se l'ELT era stato in precedenza cliccato.
        ELTCliccato = ELT;
