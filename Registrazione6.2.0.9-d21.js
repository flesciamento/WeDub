...
function GestisciTouchMoveLineaTemporale(e) {
    if (e.touches.length == 2) {
        ...
        const zoomprecedente = slideZoom.value;
        slideZoom.value -= 20 - (40 * (+e.touches[GestisciTouchMoveLineaTemporale.toccobasso].clientY > +GestisciTouchMoveLineaTemporale.PosizioneYPrec));
        Messaggio(GestisciTouchMoveLineaTemporale.contatore++ + ": " + e.touches[GestisciTouchMoveLineaTemporale.toccobasso].clientY + " - " + GestisciTouchMoveLineaTemporale.PosizioneYPrec);
        if (zoomprecedente != slideZoom.value) {CambiaZoom();}
    }
}
GestisciTouchMoveLineaTemporale.PosizioneYPrec = 0; GestisciTouchMoveLineaTemporale.toccobasso = 0; GestisciTouchMoveLineaTemporale.contatore = 0;
/****************************************/
