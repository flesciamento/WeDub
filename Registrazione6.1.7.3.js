...
function CreaFinestraOpzioniClip(RiferimentoRegistrazione) {
    ...
    divContenitoreOpzioni.iStyle({display: 'none', position: 'fixed', top: '10px', left: "30%", zIndex: 100000000 + Number(RiferimentoRegistrazione)});
