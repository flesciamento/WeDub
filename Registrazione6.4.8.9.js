...
function ImpostaStatoPlay(StatoPlay) {
    const playpausa = ["pause", "play"], statoattuale = playpausa[+StatoPlay], statoprecedente = playpausa[1 - StatoPlay];
    RiproduzioneInCorso = StatoPlay;
    imgPlayPausa.src = "images/" + statoattuale + "-blue.png";
    PlayInSovrimpressione.className = PlayInSovrimpressione.className.replace(statoprecedente, statoattuale);
}
