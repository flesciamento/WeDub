...
function CaricaColonnaInternazionale(Dati) {
    ...
    SpezzoniAudioCI.forEach((NumSpezzone) => {
        CreaNuovaClipAudio({Registrazione: SpezzoniAudioCI[NumSpezzone], N: -1, ID_Utente: 'ColonnaInternazionale', MinutaggioRegistrazione: 75 * NumSpezzone, TaglioIniziale: 0, TaglioFinale: 75, DurataRegistrazione: 75, Guadagno: Dati.volume}, "", false);
    });
