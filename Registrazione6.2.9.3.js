...
function RiposizionamentoAutomaticoClipSovrapposte(ELTConsiderato) {
    if (ELTDaSpostare == false) {
        ...
        NuoviELTDaRiordinare.sort((a, b) => {return a.Durata - b.Durata;});
        if (NuoviELTDaRiordinare[0] != datiAudioConsiderato) {RiposizionamentoAutomaticoClipSovrapposte(document.getElementById('ELTReg' + NuoviELTDaRiordinare[0].numero)); return;}
