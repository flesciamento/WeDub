...
var FunzioniCopione = {
    ...
    RiattivaVideoGuida: function () {
        const VG = document.getElementById('VideoGuida');
        clearInterval(tmrDisattivaVG);
        if (VG.dataset.modificatopointerevents == "1") {VG.style.pointerEvents = VG.dataset.pointerEvents; VG.style.modificatopointerevents = "0";}
    },
    /****************************/
