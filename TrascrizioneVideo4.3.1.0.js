    ...
    CreaListaMenu(DatiPersonaggi, inputSceltaPersonaggio,
        ...
        () => {
            ...
            if (NuovoPersonaggio) {
                ...
                AJAX("TrascrizioneVideo_SalvaNuovoPersonaggio.php", "N=" + encodeURIComponent(N) + "&NomePersonaggio=" + encodeURIComponent(NuovoPersonaggio), CaricaListaPersonaggi, "", "", true);
            } else {
