...
var FunzioniCopione = {
    ...
    Visualizza: function () {
        ...
        TestoGuida.innerHTML = "<span>" + Testo.replace(/\n/g, '<br>').replace(new RegExp('<br>([' + PatternRegexNomePersonaggio + ']+): ', 'g'), "</span><br style='line-height: 5px;'><span data-battuta='1' name=\"Battuta_$1\"><b>$1</b>:<span> </span><span contenteditable='true'>") + "</span></span><br style='line-height: 4vh;' />";
        /******************************/
