...
function CreazioneClipPrimoCaricamento(DatiClipAudio) {
    ...
    if (!ModalitaStreaming && (PresenteColonnaInternazionale || SonoCreatoreProgetto)) {SwitchColonnaInternazionale(); setTimeout(() => {pulSwitchColonnaInternazionale.style.display = "";}, 500);}
