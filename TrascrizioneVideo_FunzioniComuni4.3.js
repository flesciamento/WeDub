...
const ManigliaSposta_TestoGuida = CreaElemento('div', 'MenuTestoGuida', 'ContenitoreTestoGuida'); ManigliaSposta_TestoGuida.className = 'fa fa-navicon'; ManigliaSposta_TestoGuida.onmousedown = SpostaTestoGuida_Attiva;
