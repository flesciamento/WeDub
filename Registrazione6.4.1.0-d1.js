...
function AdattaDimensionePulsanti() {
    ...
    if (!SistemaAttualeAndroid) {
        const d = CreaElemento('div', 'debugdiv', 'bodyPagina', "Sistema Android: " + (SistemaAttualeAndroid ? "si" : "no")); d.className = "alert alert-warning"; d.iStyle({position: "fixed", top: "1%", left: "1%", zIndex: 10000000000000});
