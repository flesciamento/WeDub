                            ...
                            pulSpezzaBattute.onclick = async (e) => {
                                ...
                                if (NumeroAttacchi > 2) {
                                    ...
                                    for(A = 2; A < NumeroAttacchi; A += 2) {
                                        ...
                                        DuplicaClip(Numero, (ClipNuova) => {ClipNuova.taglioIniziale = SecondiAttacco; ClipNuova.taglioFinale = SecondiStacco; SelezionaESpostaELT(ClipNuova.numero); NuoveClipCreate.push(ClipNuova);});
                                    }
                                    divVetro.style.display = "none";
                                }
                            }
