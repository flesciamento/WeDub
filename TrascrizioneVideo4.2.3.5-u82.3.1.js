            ...
            CreaListaMenu(DatiPersonaggi, inputSceltaPersonaggio,
                ...
                () => {
                    ...
                    if (NuovoPersonaggio) {
                        ...
                        if (RichiestaModificaPersonaggio) {if (PersonaggioDaModificare != "") {FunzioneAllaSceltaPersonaggio(T, PersonaggioDaModificare);} return;} // Se non è stato scelto nulla, il personaggio non viene modificato.
                    }
