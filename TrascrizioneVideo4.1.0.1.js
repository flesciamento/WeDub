...
function MandaAdAggiornaTestoGuida() {
    ...
    AggiornaTestoGuida_slow();
    if (RiproduzioneInCorso) {FunzioniCopione.AttivaTestoGuida();}
}

function AggiornaTestoGuida_slow() {
    DatiCopione.sort((a, b) => {return a.minutaggio - b.minutaggio;});
    setTimeout(() => {FunzioniCopione.Visualizza(); FunzioniCopione.AggiornaTestoGuida();}, 100);
}
...
document.getElementById('ContenitoreVideoGuida').addEventListener('click', FunzioniCopione.AttivaTestoGuida);
