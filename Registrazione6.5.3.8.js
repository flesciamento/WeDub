...
function AttivaProgramma() {
    ...
    if (!ModalitaStreaming) {
        ...
        ContenitoreVideoGuida.append(divContenitoreSlideMinutaggio, ControlliInSovrimpressione); [divContenitoreSlideMinutaggio, ControlliInSovrimpressione].forEach(el => el.className = "AppariAlPassaggioMouseSulVideo");
