...
const FunzioniCopione = {
    ...
    GestisciIncolla: async function (e) {
        ...
        await pausa(100);
        spanEditabile.textContent = spanEditabile.innerText.replace(/[^A-z0-9àéèìòù\.\?\!'"\|£$%&\(\)=\[\]\*\-–\+ ]/g, '');
    },
    /********************************/
