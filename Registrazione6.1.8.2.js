...
function CestinaClip(Numero, SenzaAnimazione = false) {
    ...
    if (ELT) {ELT.className = "ELT transizione-morbida-" + (SenzaAnimazione? "no" : "si"); ELT.iStyle({left: "-5px", width: "10px", visibility: "hidden"}); ELT.className = "ELT transizione-morbida-si";}
