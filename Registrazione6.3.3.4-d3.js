...
function Posizionati(MinutaggioNuovo, RiabilitaTuttaLaSchermata = false) {
    ...
    function RiattivaVideoGuida() {
        ...
        if (stavoRiproducendo) {
            ...
            console.log("stavoRiproducendo = false", "VideoGuidaPause()", "RiabilitaLaSchermataSeRichiesto()", "funzioni copione");
            VideoGuidaPause();
    ...
    function RiabilitaLaSchermataSeRichiesto() {
        console.log("RiabilitaLaSchermataSeRichiesto()", "stavoRiproducendo:", stavoRiproducendo, "RiabilitaTuttaLaSchermata", RiabilitaTuttaLaSchermata);
        if (RiabilitaTuttaLaSchermata) {
            RiabilitaSchermata();
        } else {
            if (Righello.dataset.DisattivaClick == "no") {DisabilitaComandiPerRiprodurre(false);}
            console.log("RiabilitaLaSchermataSeRichiesto()", "DisabilitaComandiPerRiprodurre(false)");
        }
    }
