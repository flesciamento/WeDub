    ...
    if (!CaricamentoInizialeTerminato) {
        ...
        if (ModalitaStreaming) {
            ...
            if (DoppiatoreConsiderato && (datiAudioUtente = DatiAudioRegistrato_Utente[DoppiatoreConsiderato])) {
                const PrimaClipDaAscoltare = datiAudioUtente.find((el) => el.daAscoltare);
                if (PrimaClipDaAscoltare) {Posizionati(PrimaClipDaAscoltare.MinutaggioRegistrazione - 2); slideZoom.value = 1000; CambiaZoom();}
            }
