...
function VisualizzaSuggerimentiNuoviDoppiatori(Suggerimenti, TipoSuggerimento = '', FunzioneAlTermine = () => {}) {
    ...
    function VisualizzaSuggerimento() {
        ...
        if (Sugg.VicinoA) {Sugg.VicinoA.append(boxSuggerimenti); console.log("Vicino a", boxSuggerimenti); boxSuggerimenti.iStyle({position: "absolute", marginTop: Sugg.scostamentoY, marginLeft: Sugg.scostamentoX, top: '', bottom: '', left: '', right: ''});} else {boxSuggerimenti.iStyle(Object.assign({}, {position: 'fixed', marginTop: '', marginLeft: '', top: '', bottom: '', left: '', right: ''}, Sugg.coordinate)); console.log("coordinate", boxSuggerimenti)}
        ...
        console.log("funzione terminata", boxSuggerimenti);
    }
...
function CestinaClip(Numero) {
    ...
    if (ELT) {ELT.iStyle({left: "-5px", width: "10px", visibility: "hidden"});}
...
/*                 PrecaricaClip(SecondiPrecaricamentoAlPlay); */
            ...
            const totAudio = DatiAudioRegistrato.length;
            for (let I = 0; I < totAudio; I++) {
                if (CestinaClipRimosse(DatiAudioRegistrato[I])) {await pausa(30);}
            }
            AttivaAggiornamentoClip();
            EliminaImgAttesa();
        }
