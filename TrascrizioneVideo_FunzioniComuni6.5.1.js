...
var FunzioniCopione = {
    ...
    EvidenziaPersonaggio: function (e) {
        ...
        /* Si posiziona alla prima battuta del personaggio più vicina se non siamo già in una sua battuta e se non siamo in riproduzione */
        if (!RiproduzioneInCorso && !document.querySelector(`.${FunzioniCopione.ClasseEvidenziaBattuta} [name="Battuta_${PersonaggioDaEvidenziare}"]`)) {FunzioniCopione.PosizionatiBattutaPersonaggio(e);}
    },
    /***************************/
