...
function GestisciTouchMoveLineaTemporale(e) {
    if ((e.touches.length == 2) && (e.touches[toccobasso].clientY != GestisciTouchMoveLineaTemporale.PosizioneYPrec)) {
        ...
        Messaggio(zoomprecedente + " - " + slideZoom.value);
        if (zoomprecedente != slideZoom.value) {CambiaZoom();}
        GestisciTouchMoveLineaTemporale.PosizioneYPrec = e.touches[toccobasso].clientY;
    }
}
GestisciTouchMoveLineaTemporale.PosizioneYPrec = 0;
/****************************************/
