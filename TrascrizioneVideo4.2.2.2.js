...
function CreaNuovaTextarea(NumID, Minutaggio) {
    ...
    const tr = CreaElemento('tr', 'RigoBloccoTesto' + NumRigo, "ContenitoreTesto");
            td = CreaElemento('td', 'tdInfoMinutaggio' + NumRigo, tr.id); td.className = "colonna-minutaggio";
                    /** Minutaggio **/
                    ...
                    M = CreaElemento('span', 'MinutaggioMinuti' + NumRigo, td.id, MinutaggioAttuale.Minuti || "0"); M.style.textAlign = "right";
            
                    CreaElemento('span', 'spandivisore' + NumRigo, td.id, ":");

                    S = CreaElemento('span', 'MinutaggioSecondi' + NumRigo, td.id, VisualizzaSecondi(MinutaggioAttuale.Secondi));
