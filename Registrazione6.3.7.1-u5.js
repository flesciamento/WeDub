                ...
                tr = CreaElemento('tr', ID_Opzioni + 'TabellaOpzioniRigaVarie', Tabella.id);
                    ...
                    td = CreaElemento('td', ID_Opzioni + 'tdOpzioneRiduciRumore', tr.id);
                        ...
                        pulRiduciRumore.onclick = (e) => {
                            ...
                            console.log(profilorumore);
                            pulsante.abilita(false);
                            log = "";
                            for (let I = 0; I < lunghezzaBuffer; I++) {
                                log += "\n" + b[I] + " -> " + (b[I] / TrattamentoClip.AutoTaglioIniziale.SogliaDB) + ", " + (b[I] * Math.min(Math.abs(b[I]) / TrattamentoClip.AutoTaglioIniziale.SogliaDB, 1));
                                b[I] *= Math.min(Math.abs(b[I]) / TrattamentoClip.AutoTaglioIniziale.SogliaDB, 1);
                            }
