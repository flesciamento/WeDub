...
function RiproduciClipInSync(MinutaggioVideo) {
    ...
    ClipDaRiprodurre.forEach((I) => {
        ...
        const g = GuadagnoPrincipale[I]; GuadagnoPrincipale[I].gain.value = 0; GuadagnoPrincipale[I].gain.linearRampToValueAtTime(g, audioContext.currentTime + SecondiPartenzaAudio + 1);
