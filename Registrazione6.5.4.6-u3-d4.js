                            ...
                            pulSpezzaBattute.onclick = async (e) => {
                                ...
                                if (NumeroAttacchi > 2) {
                                    ...
                                    for(A = 2; A < NumeroAttacchi; A += 2) {
                                        DuplicaClip(Numero, (ClipNuova) => {ClipNuova.taglioIniziale = attacchi[A]; ClipNuova.taglioFinale = attacchi[+A + 1]; console.log(ClipNuova); SelezionaESpostaELT(ClipNuova.numero); console.log("ELTDaModificare", ELTDaModificare);});
                                    }
                                    divVetro.style.display = "none";
                                }
                            }
