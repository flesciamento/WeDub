...
function CambiaTool(Tool) {
    if (Righello.dataset.DisattivaClick == "si") {return;}
...
function SeguiCursore() {
    ...
    ((PosizioneAttualeCursoreNellaFinestra < 0) || (PosizioneAttualeCursoreNellaFinestra > ScorrimentoCursore.distanzaMinimaDalBordo)) && window.scrollTo(PosizioneAttualeCursore - ScorrimentoCursore.distanzaMinimaDalBordo, WindowScrollY);
}
