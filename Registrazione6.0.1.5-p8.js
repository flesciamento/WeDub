...
function RiproduciClipInSync(MinutaggioVideo) {
    ...
    ClipDaRiprodurre.forEach((I) => {
        ...
        (ModalitaStreaming && (datiAudio.audio.onended = (e) => {const da = DatiAudioRegistrato[e.currentTarget.numero]; delete da.audio; delete da.buffer; da.RichiestoCaricamentoBuffer = false;})); // Scarica la memoria
    });
