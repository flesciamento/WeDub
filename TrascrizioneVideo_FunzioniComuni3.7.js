...
CreaElemento('style', 'styleTestoGuida', document.body.id, `.TestoGuida-evidenziato {background-color: rgba(200, 255, 200);}`);
...
var FunzioniCopione = {
    AggiornaTestoGuida: function (MinutaggioAttuale = VideoGuidaMinutaggioCorrente()) {
        ...
        ((PosizioneCopione) && (SezioneTesto = document.getElementById('RifCopione' + PosizioneCopione.NumID)) && (SezioneTesto.scrollIntoView({behavior: 'smooth', block: 'center'}) && (SezioneTesto.className = "TestoGuida-evidenziato")));
