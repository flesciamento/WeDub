...
function VerificaSpezzoniColonnaInternazionaleCaricati() {
    ...
    for (let I = 0; I < totSpezzoniCI; I++) {
        ...
        if (ClipDaPrecaricare(NumeroDatiAudioRegistrato, DalMinutaggio, totDurataVideoGuida)) {CaricaBufferAudio(NumeroDatiAudioRegistrato, PlayVideoGuida); return false;}
    }
