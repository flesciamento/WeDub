...
const PatternRegexNomePersonaggio = "A-Za-z0-9àéèìòù\.\(\) ", RegexNomePersonaggio_CaratteriNonAmmessi = new RegExp('[^' + PatternRegexNomePersonaggio + ']', 'g'), RegexNomePersonaggio_CaratteriAmmessi = new RegExp('[' + PatternRegexNomePersonaggio + ']', 'g');
...
var FunzioniCopione = {
    ...
    EvidenziaPersonaggio: function (e) {
        ...
        if (!RiproduzioneInCorso && (FunzioniCopione.CopioneEditabile == 0) && !document.querySelector(`.${FunzioniCopione.ClasseEvidenziaBattuta} [name="Battuta_${PersonaggioDaEvidenziare}"]`)) {FunzioniCopione.PosizionatiBattutaPersonaggio(e);}
    },
    /***************************/
...
function FormattaTestoCopione(Testo) {
    return FunzioniCopione.FormattaTesto("<span><span><br>" + Testo + "</span></span>");
}
/*************/