...
function AttivaProgramma() {
    ...
    setTimeout(() => {
        ...
        VideoGuidaPause(); ImpostaStatoPlay(false); VideoGuidaPosizionati(0); slideMinutaggioAttuale.value = 0; setTimeout(() => {VideoGuidaImpostaVolume(vol); slideVolumeVideoGuida.value = vol;}, 1000);
        ...
        document.getElementById('LogoWEDUB').iStyle({top: 0, right: 0});
    }, 1000);
...
function VideoGuidaPronto() {
    ...
    setTimeout(() => {VideoGuidaCaricaEAvvia(PercorsoVideoGuida); VideoGuidaImpostaVolume(0); VideoGuidaImpostaEventoPrimoCaricamento(AttivaProgramma);}, 500);
}
