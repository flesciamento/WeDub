...
function AutoAdattaElementiInterfaccia() {
    ...
    const AltezzaPannelloSx = (+ContenitorePannelloSx.offsetTop) + (+ContenitorePannelloSx.offsetHeight), AltezzaPannelloDx = ContenitorePannelloDx.offsetHeight, OverflowPannelloSx = (AltezzaPannelloSx > Monitors.offsetHeight), OverflowPannelloDx = (AltezzaPannelloDx > Monitors.offsetHeight);
