...
function RiposizionamentoAutomaticoClipSovrapposte(ELTConsiderato) {
    if (ELTDaSpostare == false) {
        ...
        var ID_NuoviELTDaRiordinare = [], ID_ELT_trovati = [], NumeroELTDaRiordinare = 1, NumeroELTDaRiordinare_prec = NumeroELTDaRiordinare;
        ...
        ID_ELT_trovati.sort((a, b) => {return a > b;}); // Serve ad effettuare la sovrapposizione delle clip sempre nello stesso ordine
