...
/*		case "(": NodoAttuale.textContent = NodoAttuale.textContent.slice(0, PosizioneCursore) + ")" + NodoAttuale.textContent.slice(PosizioneCursore); ; return 2;
        ...
        case "ArrowUp":   ((PosizioneCursore < 2) && (campoprecedente = TrovaCampoTestoVicino(ElementoAttuale, -1)) && (campoprecedente.focus())); break;
        case "ArrowDown": ((PosizioneCursore > NodoAttuale.textContent.length - 5) && (camposuccessivo = TrovaCampoTestoVicino(ElementoAttuale, 1)) && (camposuccessivo.focus())); break;
