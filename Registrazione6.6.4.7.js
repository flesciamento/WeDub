...
function CreaFinestraOpzioniClip(RiferimentoRegistrazione) {
    ...
    const altezzaminimafinestra = 850;
    if (window.innerHeight < altezzaminimafinestra) {document.getElementById(ID_Opzioni).style.transform = "scale(" + (window.innerHeight / altezzaminimafinestra) + ")";}
