...
var FunzioniCopione = {
    ...
    VisualizzaSuAltraFinestra: async function () {
        finestra = ApriFinestra({currentTarget: {dataset: {altezza: 800, larghezza: 600, nomefinestra: 'CopioneTestoGuida', link: 'TestoGuidaStampabile.php?N=' + encodeURIComponent(N)}}});
        await pausa(1000);
