...
function CaricaColonnaInternazionale(Dati) {
    ...
    SpezzoniAudioCI.forEach((SpezzoneAudio) => {
        CreaNuovaClipAudio({Registrazione: SpezzoneAudio, N: -1, ID_Utente: 'ColonnaInternazionale', MinutaggioRegistrazione: 75 * NumSpezzone, TaglioIniziale: 0, TaglioFinale: 75, DurataRegistrazione: 75, Guadagno: Dati.volume}, "", false);
    });
