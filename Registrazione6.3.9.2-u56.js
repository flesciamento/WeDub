    ...
    if (!ModalitaStreaming) {
        ...
        setTimeout(() => {
            ...
            if (RuoliDaAssegnare_NumeroTraccia !== false) {
                ...
                if (!SonoCreatoreProgetto && !SessioneOspite) {AltezzaTracce = window.innerHeight - (Provino? (window.innerHeight * 0.4) : NomiTracce.children[0].offsetHeight) - 150; VariaAltezzaTracce();} // Ingrandisce lo spazio dedicato al video per i doppiatori
            }
