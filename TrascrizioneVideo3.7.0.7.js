...
function SospendiVideo(e) {
	...
	switch (e.key) {
		...
		case "Enter": clearTimeout(tmrSospendi); VideoGuidaPause(); T.removeEventListener('keyup', SospendiVideo); SP.style.opacity = 1; SP.style.zIndex = 10; T.addEventListener('keyup', ScegliPersonaggio); break;
	}
