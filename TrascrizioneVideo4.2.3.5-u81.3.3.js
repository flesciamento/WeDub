        ...
        case "Backspace":
            if (T.innerText.trim() == "") {
                ...
                if ((e.key == "Backspace") && (PosizioneCursore < 2)) {
                    ...
                    SalvaCopione(T, true,  - (2 * EraPresentePersonaggio), (EraPresentePersonaggio? spanBattuta.previousElementSibling.previousElementSibling.children.length + 3 : NumeroChildren(spanBattuta, ElementoAttuale) - 3));
                    return;
                }
            }
            break;
