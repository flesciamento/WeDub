...
function audiobufferToWav(buffer, sampleRate, opt) {
    ...
    return encodeWAV(EffettuaTrattamentoAudio(buffer, sampleRate), format, sampleRate, numChannels, bitDepth);
}
                    ...
                    td = CreaElemento('td', ID_Opzioni + 'tdOpzioneRiduciRumore', tr.id);
                        ...
                        pulRiduciRumore.onclick = async (e) => {
                            ...
                            /* for (let I = 0; I < lunghezzaprofilorumore; I++) {
                                b[I] -= RiduzioneRumore * (Math.abs(profilorumore[I]) * (1 - (2 * (b[I] < 0))));
                            } */
                            ...
                            for (let I = 0; I < lunghezzaBuffer; I++) {
                                ...
                                b[I] = (b[I] - (RiduzioneRumore * (mediaprofilorumore * (1 - (2 * (b[I] < 0)))) ) ) * condizioneraggiunta;
                            }
