...
/* 		case "Control": if (e.location == 2) {RiprendiDaPocoPrima(6);}
    ...
    setTimeout(() => {if ((opzRiprendiVideoSecondi.checked) && (TestoPrec != T.value.trim())) {RiprendiVideoAutomaticamente(T);}}, 100);
}
