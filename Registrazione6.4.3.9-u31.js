...
function CI_AttivaAudioOriginalePocoPrimaDelTermine(datiAudio) {
    if (ClipAudioTerminaPrimaDellaFineDelVideo(datiAudio)) {
        datiAudio.alPlay.push({FunzioneAlPlay: CI_AttivaAudioOriginale, latenzaEventoAlPlay: {daltermine: -tempomixCIeOriginale, riduciSeClipNelMinutaggio: true}});
    }
}
...
function DeterminaVolumeVideoGuidaPerCI() {
    if (ColonnaInternazionaleAttivata) {
        ...
        const PosizioneConAudioOriginale = (!PosizioneAttualeCI.CI ? PosizioneAttualeCI : false);
